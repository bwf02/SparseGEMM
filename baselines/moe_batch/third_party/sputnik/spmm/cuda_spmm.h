...
/**
 * @brief Batched half-precision SpMM added for the MoE kernel baseline.
 *
 * All batches have identical m/k/n/nonzeros and use contiguous fixed strides.
 * This is a true single-launch batch (grid.z), not a grouped or host-loop API.
 */
