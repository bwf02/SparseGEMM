...
// Four-stage persistent masked grouped 128x128 output tile. Two math
// warpgroups share each activation tile, read lane-ready metadata directly
// from global memory, and reuse stage 0 for the epilogue.
...
constexpr int kOutputTileMGroupedOutput128x128Stage4OutputReuseDirectMetadata = 128;
constexpr int kOutputTileNGroupedOutput128x128Stage4OutputReuseDirectMetadata = 128;
constexpr int kMathThreadsGroupedOutput128x128Stage4OutputReuseDirectMetadata = 256;
constexpr int kThreadsGroupedOutput128x128Stage4OutputReuseDirectMetadata = 384;
constexpr int kAccumulatorCountGroupedOutput128x128Stage4OutputReuseDirectMetadata = 64;
...
__device__ __forceinline__ void wgmma_grouped_output128x128_stage4_output_reuse_direct_metadata(
...
using DenseMMAGroupedOutput128x128Stage4OutputReuseDirectMetadata =
    typename deep_gemm::mma::sm90::BF16MMASelector<128>::type;

template <size_t... I>
__device__ __forceinline__ void sparse_wgmma_grouped_output128x128_stage4_output_reuse_direct_metadata_impl(
...
__device__ __forceinline__ void sparse_wgmma_grouped_output128x128_stage4_output_reuse_direct_metadata(
        const unsigned long long desc_a, const unsigned long long desc_b,
        float* accumulator, const unsigned metadata, const bool accumulate) {
    sparse_wgmma_grouped_output128x128_stage4_output_reuse_direct_metadata_impl(
        desc_a, desc_b, accumulator, metadata, accumulate,
        cute::make_index_sequence<kAccumulatorCountGroupedOutput128x128Stage4OutputReuseDirectMetadata>{});
}

template <int kPipelineStages>
__device__ __forceinline__ void advance_pipeline_grouped_output128x128_stage4_output_reuse_direct_metadata(
...
__global__ __launch_bounds__(kThreadsGroupedOutput128x128Stage4OutputReuseDirectMetadata, 1)
void hybrid_sparse_grouped_masked_output128x128_nm12_stage4_output_reuse_direct_metadata(
    ...
    constexpr int kActivationBytes =
        kOutputTileMGroupedOutput128x128Stage4OutputReuseDirectMetadata * kBlock * kBlockM *
    ...
    constexpr int tiles_per_expert =
        kMaxM /
        kOutputTileMGroupedOutput128x128Stage4OutputReuseDirectMetadata;
    constexpr int tiles_m = kNumExperts * tiles_per_expert;
    constexpr int tiles_n =
        (kN + kOutputTileNGroupedOutput128x128Stage4OutputReuseDirectMetadata - 1) /
        kOutputTileNGroupedOutput128x128Stage4OutputReuseDirectMetadata;
...
#pragma unroll
    ...
    for (int tile_idx = static_cast<int>(blockIdx.x);
        ...
        const int output_tile_n =
            tile_n * kOutputTileNGroupedOutput128x128Stage4OutputReuseDirectMetadata;
...
#pragma unroll
                ...
                if (is_leader) {
                    deep_gemm::tma::copy<
                        kBlock * kBlockM,
                        kOutputTileMGroupedOutput128x128Stage4OutputReuseDirectMetadata, 128,
                        cutlass::bfloat16_t>(
                ...
                advance_pipeline_grouped_output128x128_stage4_output_reuse_direct_metadata<kPipelineStages>(
        ...
        if (warp < 8) {
            ...
            float accumulator[kAccumulatorCountGroupedOutput128x128Stage4OutputReuseDirectMetadata] = {};
...
#pragma unroll
                for (int i = 0;
                     i < kAccumulatorCountGroupedOutput128x128Stage4OutputReuseDirectMetadata; ++i)
                ...
                if constexpr (kBlockN == 1 && kBlockM == 2) {
                    ...
                    if (thread_in_metadata_group < 2) {
                        ...
                        const long long metadata_base =
                            selector_index * kBlockN * 128;
                        metadata_0 = hardware_metadata[
                            metadata_base +
                            warp_in_math_wg * 16 + active_lane];
                        metadata_1 = hardware_metadata[
                            metadata_base +
                    ...
                    wgmma_grouped_output128x128_stage4_output_reuse_direct_metadata(
                        ...
                        for (int k_tile = 0; k_tile < 2; ++k_tile) {
                            ...
                            const auto desc_b =
                                deep_gemm::mma::sm90::make_smem_desc(
                                    ...
                                    0, 1024);
                            sparse_wgmma_grouped_output128x128_stage4_output_reuse_direct_metadata(
                            ...
                            const auto desc_b =
                                deep_gemm::mma::sm90::make_smem_desc(
                                    ...
                                    static_cast<int>(
                                        cute::GMMA::LayoutType::B128),
                                    0, 1024);
                            DenseMMAGroupedOutput128x128Stage4OutputReuseDirectMetadata::wgmma(
                                desc_a.desc_, desc_b.desc_, accumulator,
                                has_accumulator || local_block != 0 ||
                                    k_tile != 0);
                        }
...
#pragma unroll
            for (int atom = 0; atom < 16; ++atom) {
                ...
                auto* smem_ptr =
                    smem_output +
                    weight_row *
                        kOutputTileMGroupedOutput128x128Stage4OutputReuseDirectMetadata * kBlock +
                    (atom * 8 + row) * kBlock +
                    ((col ^ row) * 8);
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsGroupedOutput128x128Stage4OutputReuseDirectMetadata, 0);
...
#pragma unroll
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsGroupedOutput128x128Stage4OutputReuseDirectMetadata, 1);
        }
        if (warp == 0 || warp == 10)
            cutlass::arch::NamedBarrier::sync(64, 2);
    }
}
