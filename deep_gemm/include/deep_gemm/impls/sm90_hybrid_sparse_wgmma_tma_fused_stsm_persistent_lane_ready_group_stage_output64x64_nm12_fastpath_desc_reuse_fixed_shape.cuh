...
constexpr int kOutputTileMProducerMetadataGroupStage64x64NM12DescReuseFixedShape = 64;
constexpr int kOutputTileNProducerMetadataGroupStage64x64NM12DescReuseFixedShape = 64;
constexpr int kMathThreadsProducerMetadataGroupStage64x64NM12DescReuseFixedShape = 128;
constexpr int kThreadsProducerMetadataGroupStage64x64NM12DescReuseFixedShape = 256;
constexpr int kAccumulatorCountProducerMetadataGroupStage64x64NM12DescReuseFixedShape = 32;

using DenseMMAProducerMetadataGroupStage64x64NM12DescReuseFixedShape =
    typename deep_gemm::mma::sm90::BF16MMASelector<64>::type;

template <size_t... I>
__device__ __forceinline__ void sparse_wgmma_group_stage_64x64_nm12_desc_reuse_fixed_shape_impl(
...
__device__ __forceinline__ void sparse_wgmma_group_stage_64x64_nm12_desc_reuse_fixed_shape(
        const unsigned long long desc_a, const unsigned long long desc_b,
        float* accumulator, const unsigned metadata, const bool accumulate) {
    sparse_wgmma_group_stage_64x64_nm12_desc_reuse_fixed_shape_impl(
        desc_a, desc_b, accumulator, metadata, accumulate,
        cute::make_index_sequence<kAccumulatorCountProducerMetadataGroupStage64x64NM12DescReuseFixedShape>{});
}

template <int kPipelineStages>
__device__ __forceinline__ void advance_pipeline_group_stage_64x64_nm12_desc_reuse_fixed_shape(
...
__global__ __launch_bounds__(kThreadsProducerMetadataGroupStage64x64NM12DescReuseFixedShape, 1)
void hybrid_sparse_group_stage_output64x64_nm12_fastpath_desc_reuse_fixed_shape(
    ...
    constexpr int kActivationBytes =
        kOutputTileMProducerMetadataGroupStage64x64NM12DescReuseFixedShape * kBlock * kBlockM *
    ...
    constexpr int kOutputBytes =
        kOutputTileMProducerMetadataGroupStage64x64NM12DescReuseFixedShape *
        kOutputTileNProducerMetadataGroupStage64x64NM12DescReuseFixedShape * sizeof(__nv_bfloat16);
    ...
    constexpr int tiles_m =
        (kM + kOutputTileMProducerMetadataGroupStage64x64NM12DescReuseFixedShape - 1) /
        kOutputTileMProducerMetadataGroupStage64x64NM12DescReuseFixedShape;
    constexpr int tiles_n =
        (kN + kOutputTileNProducerMetadataGroupStage64x64NM12DescReuseFixedShape - 1) /
        kOutputTileNProducerMetadataGroupStage64x64NM12DescReuseFixedShape;
...
#pragma unroll
    ...
    for (int tile_idx = static_cast<int>(blockIdx.x);
        ...
        const int output_tile_m =
            tile_m * kOutputTileMProducerMetadataGroupStage64x64NM12DescReuseFixedShape;
        const int output_tile_n =
            tile_n * kOutputTileNProducerMetadataGroupStage64x64NM12DescReuseFixedShape;
...
#pragma unroll
                ...
                if (is_leader) {
                    deep_gemm::tma::copy<
                        kBlock * kBlockM,
                        kOutputTileMProducerMetadataGroupStage64x64NM12DescReuseFixedShape, 128,
                        cutlass::bfloat16_t>(
                ...
                advance_pipeline_group_stage_64x64_nm12_desc_reuse_fixed_shape<kPipelineStages>(
                    producer_stage, producer_phase);
            }
        }

        if (warp < 4) {
            float accumulator[kAccumulatorCountProducerMetadataGroupStage64x64NM12DescReuseFixedShape] = {};
...
#pragma unroll
                for (int i = 0;
                     i < kAccumulatorCountProducerMetadataGroupStage64x64NM12DescReuseFixedShape; ++i)
                    ...
                    for (int k_tile = 0; k_tile < 2; ++k_tile) {
                        ...
                        activation_desc.reg32_[0] =
                            ...
                            (sparse_local_block *
                             ...
                             k_tile * 32) /
                                8;
                        sparse_wgmma_group_stage_64x64_nm12_desc_reuse_fixed_shape(
                    ...
                    for (int k_tile = 0; k_tile < 4; ++k_tile) {
                        ...
                        activation_desc.reg32_[0] =
                            ...
                            (dense_local_block *
                             ...
                             k_tile * 16) /
                                8;
                        DenseMMAProducerMetadataGroupStage64x64NM12DescReuseFixedShape::wgmma(
...
#pragma unroll
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsProducerMetadataGroupStage64x64NM12DescReuseFixedShape, 0);
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsProducerMetadataGroupStage64x64NM12DescReuseFixedShape, 1);
        }
    }
}
