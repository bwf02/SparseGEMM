...
constexpr int kOutputTileMProducerMetadataGroupStage96x64NM12DescReuse = 96;
constexpr int kOutputTileNProducerMetadataGroupStage96x64NM12DescReuse = 64;
constexpr int kMathThreadsProducerMetadataGroupStage96x64NM12DescReuse = 128;
constexpr int kThreadsProducerMetadataGroupStage96x64NM12DescReuse = 256;
constexpr int kAccumulatorCountProducerMetadataGroupStage96x64NM12DescReuse = 48;

using DenseMMAProducerMetadataGroupStage96x64NM12DescReuse =
    typename deep_gemm::mma::sm90::BF16MMASelector<96>::type;

template <size_t... I>
__device__ __forceinline__ void sparse_wgmma_group_stage_96x64_nm12_desc_reuse_impl(
    ...
    using SparseMMA = cute::SM90::GMMA::SPARSE::
        GMMA_64x96x32_F32BF16BF16_SS<cute::GMMA::Major::K,
                                     cute::GMMA::Major::K>;
    SparseMMA::fma(
...
__device__ __forceinline__ void sparse_wgmma_group_stage_96x64_nm12_desc_reuse(
        const unsigned long long desc_a, const unsigned long long desc_b,
        float* accumulator, const unsigned metadata, const bool accumulate) {
    sparse_wgmma_group_stage_96x64_nm12_desc_reuse_impl(
        desc_a, desc_b, accumulator, metadata, accumulate,
        cute::make_index_sequence<kAccumulatorCountProducerMetadataGroupStage96x64NM12DescReuse>{});
}

template <int kPipelineStages>
__device__ __forceinline__ void advance_pipeline_group_stage_96x64_nm12_desc_reuse(
...
__global__ __launch_bounds__(kThreadsProducerMetadataGroupStage96x64NM12DescReuse, 1)
void hybrid_sparse_group_stage_output96x64_nm12_fastpath_desc_reuse(
    ...
    constexpr int kActivationBytes =
        kOutputTileMProducerMetadataGroupStage96x64NM12DescReuse * kBlock * kBlockM *
    ...
    constexpr int kOutputBytes =
        kOutputTileMProducerMetadataGroupStage96x64NM12DescReuse *
        kOutputTileNProducerMetadataGroupStage96x64NM12DescReuse * sizeof(__nv_bfloat16);
    ...
    const int tiles_m =
        (m + kOutputTileMProducerMetadataGroupStage96x64NM12DescReuse - 1) /
        kOutputTileMProducerMetadataGroupStage96x64NM12DescReuse;
    const int tiles_n =
        (n + kOutputTileNProducerMetadataGroupStage96x64NM12DescReuse - 1) /
        kOutputTileNProducerMetadataGroupStage96x64NM12DescReuse;
...
#pragma unroll
    ...
    for (int tile_idx = static_cast<int>(blockIdx.x);
        ...
        const int output_tile_m =
            tile_m * kOutputTileMProducerMetadataGroupStage96x64NM12DescReuse;
        const int output_tile_n =
            tile_n * kOutputTileNProducerMetadataGroupStage96x64NM12DescReuse;
...
#pragma unroll
                ...
                if (is_leader) {
                    deep_gemm::tma::copy<
                        kBlock * kBlockM,
                        kOutputTileMProducerMetadataGroupStage96x64NM12DescReuse, 128,
                        cutlass::bfloat16_t>(
                ...
                advance_pipeline_group_stage_96x64_nm12_desc_reuse<kPipelineStages>(
                    producer_stage, producer_phase);
            }
        }

        if (warp < 4) {
            float accumulator[kAccumulatorCountProducerMetadataGroupStage96x64NM12DescReuse] = {};
...
#pragma unroll
                for (int i = 0;
                     i < kAccumulatorCountProducerMetadataGroupStage96x64NM12DescReuse; ++i)
                    ...
                    for (int k_tile = 0; k_tile < 2; ++k_tile) {
                        ...
                        activation_desc.reg32_[0] =
                            ...
                            (sparse_local_block *
                             ...
                             k_tile * 32) /
                                8;
                        sparse_wgmma_group_stage_96x64_nm12_desc_reuse(
                    ...
                    for (int k_tile = 0; k_tile < 4; ++k_tile) {
                        ...
                        activation_desc.reg32_[0] =
                            ...
                            (dense_local_block *
                             ...
                             k_tile * 16) /
                                8;
                        DenseMMAProducerMetadataGroupStage96x64NM12DescReuse::wgmma(
...
#pragma unroll
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsProducerMetadataGroupStage96x64NM12DescReuse, 0);
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsProducerMetadataGroupStage96x64NM12DescReuse, 1);
        }
    }
}
