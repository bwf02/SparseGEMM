...
constexpr int kOutputTileMProducerMetadataGroupStage64x64NM12 = 64;
constexpr int kOutputTileNProducerMetadataGroupStage64x64NM12 = 64;
constexpr int kMathThreadsProducerMetadataGroupStage64x64NM12 = 128;
constexpr int kThreadsProducerMetadataGroupStage64x64NM12 = 256;
constexpr int kAccumulatorCountProducerMetadataGroupStage64x64NM12 = 32;

using DenseMMAProducerMetadataGroupStage64x64NM12 =
    typename deep_gemm::mma::sm90::BF16MMASelector<64>::type;

template <size_t... I>
__device__ __forceinline__ void sparse_wgmma_group_stage_64x64_nm12_impl(
...
__device__ __forceinline__ void sparse_wgmma_group_stage_64x64_nm12(
        const unsigned long long desc_a, const unsigned long long desc_b,
        float* accumulator, const unsigned metadata, const bool accumulate) {
    sparse_wgmma_group_stage_64x64_nm12_impl(
        desc_a, desc_b, accumulator, metadata, accumulate,
        cute::make_index_sequence<kAccumulatorCountProducerMetadataGroupStage64x64NM12>{});
}

template <int kPipelineStages>
__device__ __forceinline__ void advance_pipeline_group_stage_64x64_nm12(
...
__global__ __launch_bounds__(kThreadsProducerMetadataGroupStage64x64NM12, 1)
void hybrid_sparse_group_stage_output64x64_nm12_fastpath(
    ...
    constexpr int kActivationBytes =
        kOutputTileMProducerMetadataGroupStage64x64NM12 * kBlock * kBlockM *
    ...
    constexpr int kOutputBytes =
        kOutputTileMProducerMetadataGroupStage64x64NM12 *
        kOutputTileNProducerMetadataGroupStage64x64NM12 * sizeof(__nv_bfloat16);
    ...
    const int tiles_m =
        (m + kOutputTileMProducerMetadataGroupStage64x64NM12 - 1) /
        kOutputTileMProducerMetadataGroupStage64x64NM12;
    const int tiles_n =
        (n + kOutputTileNProducerMetadataGroupStage64x64NM12 - 1) /
        kOutputTileNProducerMetadataGroupStage64x64NM12;
...
#pragma unroll
    ...
    for (int tile_idx = static_cast<int>(blockIdx.x);
        ...
        const int output_tile_m =
            tile_m * kOutputTileMProducerMetadataGroupStage64x64NM12;
        const int output_tile_n =
            tile_n * kOutputTileNProducerMetadataGroupStage64x64NM12;
...
#pragma unroll
                ...
                if (is_leader) {
                    deep_gemm::tma::copy<
                        kBlock * kBlockM,
                        kOutputTileMProducerMetadataGroupStage64x64NM12, 128,
                        cutlass::bfloat16_t>(
                ...
                advance_pipeline_group_stage_64x64_nm12<kPipelineStages>(
                    producer_stage, producer_phase);
            }
        }

        if (warp < 4) {
            float accumulator[kAccumulatorCountProducerMetadataGroupStage64x64NM12] = {};
...
#pragma unroll
                for (int i = 0;
                     i < kAccumulatorCountProducerMetadataGroupStage64x64NM12; ++i)
                    ...
                    for (int k_tile = 0; k_tile < 2; ++k_tile) {
                        ...
                        const auto desc_b =
                            deep_gemm::mma::sm90::make_smem_desc(
                                ...
                                0, 1024);
                        sparse_wgmma_group_stage_64x64_nm12(
                        ...
                        const auto desc_b =
                            deep_gemm::mma::sm90::make_smem_desc(
                                ...
                                static_cast<int>(
                                    cute::GMMA::LayoutType::B128),
                                0, 1024);
                        DenseMMAProducerMetadataGroupStage64x64NM12::wgmma(
...
#pragma unroll
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsProducerMetadataGroupStage64x64NM12, 0);
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsProducerMetadataGroupStage64x64NM12, 1);
        }
    }
}
