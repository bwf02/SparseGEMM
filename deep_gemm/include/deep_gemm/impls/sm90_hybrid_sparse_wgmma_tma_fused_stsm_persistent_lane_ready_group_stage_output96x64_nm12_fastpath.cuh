...
constexpr int kOutputTileMProducerMetadataGroupStage96x64NM12 = 96;
constexpr int kOutputTileNProducerMetadataGroupStage96x64NM12 = 64;
constexpr int kMathThreadsProducerMetadataGroupStage96x64NM12 = 128;
constexpr int kThreadsProducerMetadataGroupStage96x64NM12 = 256;
constexpr int kAccumulatorCountProducerMetadataGroupStage96x64NM12 = 48;

using DenseMMAProducerMetadataGroupStage96x64NM12 =
    typename deep_gemm::mma::sm90::BF16MMASelector<96>::type;

template <size_t... I>
__device__ __forceinline__ void sparse_wgmma_group_stage_96x64_nm12_impl(
...
__device__ __forceinline__ void sparse_wgmma_group_stage_96x64_nm12(
        const unsigned long long desc_a, const unsigned long long desc_b,
        float* accumulator, const unsigned metadata, const bool accumulate) {
    sparse_wgmma_group_stage_96x64_nm12_impl(
        desc_a, desc_b, accumulator, metadata, accumulate,
        cute::make_index_sequence<kAccumulatorCountProducerMetadataGroupStage96x64NM12>{});
}

template <int kPipelineStages>
__device__ __forceinline__ void advance_pipeline_group_stage_96x64_nm12(
...
__global__ __launch_bounds__(kThreadsProducerMetadataGroupStage96x64NM12, 1)
void hybrid_sparse_group_stage_output96x64_nm12_fastpath(
    ...
    constexpr int kActivationBytes =
        kOutputTileMProducerMetadataGroupStage96x64NM12 * kBlock * kBlockM *
    ...
    constexpr int kOutputBytes =
        kOutputTileMProducerMetadataGroupStage96x64NM12 *
        kOutputTileNProducerMetadataGroupStage96x64NM12 * sizeof(__nv_bfloat16);
    ...
    const int tiles_m =
        (m + kOutputTileMProducerMetadataGroupStage96x64NM12 - 1) /
        kOutputTileMProducerMetadataGroupStage96x64NM12;
    const int tiles_n =
        (n + kOutputTileNProducerMetadataGroupStage96x64NM12 - 1) /
        kOutputTileNProducerMetadataGroupStage96x64NM12;
...
#pragma unroll
    ...
    for (int tile_idx = static_cast<int>(blockIdx.x);
        ...
        const int output_tile_m =
            tile_m * kOutputTileMProducerMetadataGroupStage96x64NM12;
        const int output_tile_n =
            tile_n * kOutputTileNProducerMetadataGroupStage96x64NM12;
...
#pragma unroll
                ...
                if (is_leader) {
                    deep_gemm::tma::copy<
                        kBlock * kBlockM,
                        kOutputTileMProducerMetadataGroupStage96x64NM12, 128,
                        cutlass::bfloat16_t>(
                ...
                advance_pipeline_group_stage_96x64_nm12<kPipelineStages>(
                    producer_stage, producer_phase);
            }
        }

        if (warp < 4) {
            float accumulator[kAccumulatorCountProducerMetadataGroupStage96x64NM12] = {};
...
#pragma unroll
                for (int i = 0;
                     i < kAccumulatorCountProducerMetadataGroupStage96x64NM12; ++i)
                    ...
                    for (int k_tile = 0; k_tile < 2; ++k_tile) {
                        ...
                        const auto desc_b =
                            deep_gemm::mma::sm90::make_smem_desc(
                                ...
                                0, 1024);
                        sparse_wgmma_group_stage_96x64_nm12(
                        ...
                        const auto desc_b =
                            deep_gemm::mma::sm90::make_smem_desc(
                                ...
                                static_cast<int>(
                                    cute::GMMA::LayoutType::B128),
                                0, 1024);
                        DenseMMAProducerMetadataGroupStage96x64NM12::wgmma(
...
#pragma unroll
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsProducerMetadataGroupStage96x64NM12, 0);
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsProducerMetadataGroupStage96x64NM12, 1);
        }
    }
}
