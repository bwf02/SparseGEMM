...
constexpr int kOutputTileMProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollK = 128;
constexpr int kOutputTileNProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollK = 64;
constexpr int kMathThreadsProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollK = 128;
constexpr int kThreadsProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollK = 256;
constexpr int kAccumulatorCountProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollK = 64;
...
__device__ __forceinline__ void wgmma_group_stage_128x64_nm12_desc_reuse_fused_mma_group_fixed_shape_unroll_k(
...
using DenseMMAProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollK =
    typename deep_gemm::mma::sm90::BF16MMASelector<128>::type;

template <size_t... I>
__device__ __forceinline__ void sparse_wgmma_group_stage_128x64_nm12_desc_reuse_fused_mma_group_fixed_shape_unroll_k_impl(
...
__device__ __forceinline__ void sparse_wgmma_group_stage_128x64_nm12_desc_reuse_fused_mma_group_fixed_shape_unroll_k(
        const unsigned long long desc_a, const unsigned long long desc_b,
        float* accumulator, const unsigned metadata, const bool accumulate) {
    sparse_wgmma_group_stage_128x64_nm12_desc_reuse_fused_mma_group_fixed_shape_unroll_k_impl(
        desc_a, desc_b, accumulator, metadata, accumulate,
        cute::make_index_sequence<kAccumulatorCountProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollK>{});
}

template <int kPipelineStages>
__device__ __forceinline__ void advance_pipeline_group_stage_128x64_nm12_desc_reuse_fused_mma_group_fixed_shape_unroll_k(
...
__global__ __launch_bounds__(kThreadsProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollK, 1)
void hybrid_sparse_group_stage_output128x64_nm12_fastpath_desc_reuse_fused_mma_group_fixed_shape_unroll_k(
    ...
    constexpr int kActivationBytes =
        kOutputTileMProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollK * kBlock * kBlockM *
    ...
    constexpr int kOutputBytes =
        kOutputTileMProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollK *
        kOutputTileNProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollK * sizeof(__nv_bfloat16);
    ...
    constexpr int tiles_m =
        (kM + kOutputTileMProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollK - 1) /
        kOutputTileMProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollK;
    constexpr int tiles_n =
        (kN + kOutputTileNProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollK - 1) /
        kOutputTileNProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollK;
...
#pragma unroll
    ...
    if (tile_idx < total_tiles) {
        ...
        const int output_tile_m =
            tile_m * kOutputTileMProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollK;
        const int output_tile_n =
            tile_n * kOutputTileNProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollK;
...
#pragma unroll
                ...
                if (is_leader) {
                    deep_gemm::tma::copy<
                        kBlock * kBlockM,
                        kOutputTileMProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollK, 128,
                        cutlass::bfloat16_t>(
                ...
                advance_pipeline_group_stage_128x64_nm12_desc_reuse_fused_mma_group_fixed_shape_unroll_k<kPipelineStages>(
                    producer_stage, producer_phase);
            }
        }

        if (warp < 4) {
            float accumulator[kAccumulatorCountProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollK] = {};
...
#pragma unroll
                for (int i = 0;
                     i < kAccumulatorCountProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollK; ++i)
                ...
                if constexpr (kBlockN == 1 && kBlockM == 2) {
                    ...
                    wgmma_group_stage_128x64_nm12_desc_reuse_fused_mma_group_fixed_shape_unroll_k(
                        ...
                        for (int k_tile = 0; k_tile < 2; ++k_tile) {
                            ...
                            const auto desc_b =
                                deep_gemm::mma::sm90::make_smem_desc(
                                    ...
                                    0, 1024);
                            sparse_wgmma_group_stage_128x64_nm12_desc_reuse_fused_mma_group_fixed_shape_unroll_k(
                            ...
                            const auto desc_b =
                                deep_gemm::mma::sm90::make_smem_desc(
                                    ...
                                    static_cast<int>(
                                        cute::GMMA::LayoutType::B128),
                                    0, 1024);
                            DenseMMAProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollK::wgmma(
                                desc_a.desc_, desc_b.desc_, accumulator,
                                has_accumulator || local_block != 0 ||
                                    k_tile != 0);
                        }
...
#pragma unroll
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollK, 0);
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollK, 1);
        }
    }
}
