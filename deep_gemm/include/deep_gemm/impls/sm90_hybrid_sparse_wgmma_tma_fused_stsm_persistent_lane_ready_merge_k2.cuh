...
// Persistent lane-ready kernel merging two logical K blocks per WGMMA group.

#include <deep_gemm/impls/sm90_hybrid_sparse_wgmma_tma_fused_stsm.cuh>

template <int = 0>
__global__ __launch_bounds__(kThreads, 1)
void hybrid_sparse_fused_wgmma_tma_stsm_persistent_lane_ready_merge_k2(
...
#pragma unroll
                    ...
                    if (pending_count == 2 || is_last_block) {
