...
constexpr int kOutputTileMProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupUniformDesc = 64;
constexpr int kOutputTileNProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupUniformDesc = 64;
constexpr int kMathThreadsProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupUniformDesc = 128;
constexpr int kThreadsProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupUniformDesc = 256;
constexpr int kAccumulatorCountProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupUniformDesc = 32;

__device__ __forceinline__ void wgmma_group_stage_64x64_nm12_desc_reuse_fixed_shape_stage7_fused_mma_group_uniform_desc(
...
using DenseMMAProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupUniformDesc =
    typename deep_gemm::mma::sm90::BF16MMASelector<64>::type;

template <size_t... I>
__device__ __forceinline__ void sparse_wgmma_group_stage_64x64_nm12_desc_reuse_fixed_shape_stage7_fused_mma_group_uniform_desc_impl(
...
__device__ __forceinline__ void sparse_wgmma_group_stage_64x64_nm12_desc_reuse_fixed_shape_stage7_fused_mma_group_uniform_desc(
        const unsigned long long desc_a, const unsigned long long desc_b,
        float* accumulator, const unsigned metadata, const bool accumulate) {
    sparse_wgmma_group_stage_64x64_nm12_desc_reuse_fixed_shape_stage7_fused_mma_group_uniform_desc_impl(
        desc_a, desc_b, accumulator, metadata, accumulate,
        cute::make_index_sequence<kAccumulatorCountProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupUniformDesc>{});
}

template <int kPipelineStages>
__device__ __forceinline__ void advance_pipeline_group_stage_64x64_nm12_desc_reuse_fixed_shape_stage7_fused_mma_group_uniform_desc(
...
__global__ __launch_bounds__(kThreadsProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupUniformDesc, 1)
void hybrid_sparse_group_stage_output64x64_nm12_fastpath_desc_reuse_fixed_shape_stage7_fused_mma_group_uniform_desc(
    ...
    constexpr int kActivationBytes =
        kOutputTileMProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupUniformDesc * kBlock * kBlockM *
    ...
    constexpr int kOutputBytes =
        kOutputTileMProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupUniformDesc *
        kOutputTileNProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupUniformDesc * sizeof(__nv_bfloat16);
    ...
    constexpr int tiles_m =
        (kM + kOutputTileMProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupUniformDesc - 1) /
        kOutputTileMProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupUniformDesc;
    constexpr int tiles_n =
        (kN + kOutputTileNProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupUniformDesc - 1) /
        kOutputTileNProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupUniformDesc;
    ...
    const unsigned dense_desc_base_lo = dense_desc.reg32_[0];
    const unsigned sparse_desc_base_lo = sparse_desc.reg32_[0];
    const unsigned activation_desc_base_lo = activation_desc.reg32_[0];
...
#pragma unroll
    ...
    for (int tile_idx = static_cast<int>(blockIdx.x);
        ...
        const int output_tile_m =
            tile_m * kOutputTileMProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupUniformDesc;
        const int output_tile_n =
            tile_n * kOutputTileNProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupUniformDesc;
...
#pragma unroll
                ...
                if (is_leader) {
                    deep_gemm::tma::copy<
                        kBlock * kBlockM,
                        kOutputTileMProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupUniformDesc, 128,
                        cutlass::bfloat16_t>(
                ...
                advance_pipeline_group_stage_64x64_nm12_desc_reuse_fixed_shape_stage7_fused_mma_group_uniform_desc<kPipelineStages>(
                    producer_stage, producer_phase);
            }
        }

        if (warp < 4) {
            float accumulator[kAccumulatorCountProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupUniformDesc] = {};
...
#pragma unroll
                for (int i = 0;
                     i < kAccumulatorCountProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupUniformDesc; ++i)
                ...
                if constexpr (kBlockN == 1 && kBlockM == 2) {
                    ...
                    wgmma_group_stage_64x64_nm12_desc_reuse_fixed_shape_stage7_fused_mma_group_uniform_desc(
                        ...
                        for (int k_tile = 0; k_tile < 2; ++k_tile) {
                            ...
                            const auto desc_b =
                                deep_gemm::mma::sm90::make_smem_desc(
                                    ...
                                    0, 1024);
                            sparse_wgmma_group_stage_64x64_nm12_desc_reuse_fixed_shape_stage7_fused_mma_group_uniform_desc(
                            ...
                            const auto desc_b =
                                deep_gemm::mma::sm90::make_smem_desc(
                                    ...
                                    static_cast<int>(
                                        cute::GMMA::LayoutType::B128),
                                    0, 1024);
                            DenseMMAProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupUniformDesc::wgmma(
                                desc_a.desc_, desc_b.desc_, accumulator,
                                has_accumulator || local_block != 0 ||
                                    k_tile != 0);
                        }
...
#pragma unroll
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupUniformDesc, 0);
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupUniformDesc, 1);
        }
    }
}
