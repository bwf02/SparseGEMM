...
// Four-stage persistent masked grouped 128x64 output tile with a full-row
// epilogue fast path that avoids the tail-zeroing barrier.
...
void hybrid_sparse_grouped_masked_output128x64_nm12_stage4_full_tile_epilogue(
