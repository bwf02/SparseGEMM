...
constexpr int kOutputTileMProducerMetadataGroupStage80x64NM12 = 80;
constexpr int kOutputTileNProducerMetadataGroupStage80x64NM12 = 64;
constexpr int kMathThreadsProducerMetadataGroupStage80x64NM12 = 128;
constexpr int kThreadsProducerMetadataGroupStage80x64NM12 = 256;
constexpr int kAccumulatorCountProducerMetadataGroupStage80x64NM12 = 40;

using DenseMMAProducerMetadataGroupStage80x64NM12 =
    typename deep_gemm::mma::sm90::BF16MMASelector<80>::type;

template <size_t... I>
__device__ __forceinline__ void sparse_wgmma_group_stage_80x64_nm12_impl(
...
__device__ __forceinline__ void sparse_wgmma_group_stage_80x64_nm12(
        const unsigned long long desc_a, const unsigned long long desc_b,
        float* accumulator, const unsigned metadata, const bool accumulate) {
    sparse_wgmma_group_stage_80x64_nm12_impl(
        desc_a, desc_b, accumulator, metadata, accumulate,
        cute::make_index_sequence<kAccumulatorCountProducerMetadataGroupStage80x64NM12>{});
}

template <int kPipelineStages>
__device__ __forceinline__ void advance_pipeline_group_stage_80x64_nm12(
...
__global__ __launch_bounds__(kThreadsProducerMetadataGroupStage80x64NM12, 1)
void hybrid_sparse_group_stage_output80x64_nm12_fastpath(
    ...
    constexpr int kActivationBytes =
        kOutputTileMProducerMetadataGroupStage80x64NM12 * kBlock * kBlockM *
    ...
    constexpr int kOutputBytes =
        kOutputTileMProducerMetadataGroupStage80x64NM12 *
        kOutputTileNProducerMetadataGroupStage80x64NM12 * sizeof(__nv_bfloat16);
    ...
    const int tiles_m =
        (m + kOutputTileMProducerMetadataGroupStage80x64NM12 - 1) /
        kOutputTileMProducerMetadataGroupStage80x64NM12;
    const int tiles_n =
        (n + kOutputTileNProducerMetadataGroupStage80x64NM12 - 1) /
        kOutputTileNProducerMetadataGroupStage80x64NM12;
...
#pragma unroll
    ...
    for (int tile_idx = static_cast<int>(blockIdx.x);
        ...
        const int output_tile_m =
            tile_m * kOutputTileMProducerMetadataGroupStage80x64NM12;
        const int output_tile_n =
            tile_n * kOutputTileNProducerMetadataGroupStage80x64NM12;
...
#pragma unroll
                ...
                if (is_leader) {
                    deep_gemm::tma::copy<
                        kBlock * kBlockM,
                        kOutputTileMProducerMetadataGroupStage80x64NM12, 128,
                        cutlass::bfloat16_t>(
                ...
                advance_pipeline_group_stage_80x64_nm12<kPipelineStages>(
                    producer_stage, producer_phase);
            }
        }

        if (warp < 4) {
            float accumulator[kAccumulatorCountProducerMetadataGroupStage80x64NM12] = {};
...
#pragma unroll
                for (int i = 0;
                     i < kAccumulatorCountProducerMetadataGroupStage80x64NM12; ++i)
                    ...
                    for (int k_tile = 0; k_tile < 2; ++k_tile) {
                        ...
                        const auto desc_b =
                            deep_gemm::mma::sm90::make_smem_desc(
                                ...
                                0, 1024);
                        sparse_wgmma_group_stage_80x64_nm12(
                        ...
                        const auto desc_b =
                            deep_gemm::mma::sm90::make_smem_desc(
                                ...
                                static_cast<int>(
                                    cute::GMMA::LayoutType::B128),
                                0, 1024);
                        DenseMMAProducerMetadataGroupStage80x64NM12::wgmma(
...
#pragma unroll
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsProducerMetadataGroupStage80x64NM12, 0);
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsProducerMetadataGroupStage80x64NM12, 1);
        }
    }
}
