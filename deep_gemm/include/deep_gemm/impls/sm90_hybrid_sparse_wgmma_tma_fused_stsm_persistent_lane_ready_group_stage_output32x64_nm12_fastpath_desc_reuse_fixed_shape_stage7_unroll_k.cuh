...
constexpr int kOutputTileMProducerMetadataGroupStage32x64NM12DescReuseFixedShapeStage7UnrollK = 32;
constexpr int kOutputTileNProducerMetadataGroupStage32x64NM12DescReuseFixedShapeStage7UnrollK = 64;
constexpr int kMathThreadsProducerMetadataGroupStage32x64NM12DescReuseFixedShapeStage7UnrollK = 128;
constexpr int kThreadsProducerMetadataGroupStage32x64NM12DescReuseFixedShapeStage7UnrollK = 256;
constexpr int kAccumulatorCountProducerMetadataGroupStage32x64NM12DescReuseFixedShapeStage7UnrollK = 16;

using DenseMMAProducerMetadataGroupStage32x64NM12DescReuseFixedShapeStage7UnrollK =
    typename deep_gemm::mma::sm90::BF16MMASelector<32>::type;

template <size_t... I>
__device__ __forceinline__ void sparse_wgmma_group_stage_32x64_nm12_desc_reuse_fixed_shape_stage7_unroll_k_impl(
...
__device__ __forceinline__ void sparse_wgmma_group_stage_32x64_nm12_desc_reuse_fixed_shape_stage7_unroll_k(
        const unsigned long long desc_a, const unsigned long long desc_b,
        float* accumulator, const unsigned metadata, const bool accumulate) {
    sparse_wgmma_group_stage_32x64_nm12_desc_reuse_fixed_shape_stage7_unroll_k_impl(
        desc_a, desc_b, accumulator, metadata, accumulate,
        cute::make_index_sequence<kAccumulatorCountProducerMetadataGroupStage32x64NM12DescReuseFixedShapeStage7UnrollK>{});
}

template <int kPipelineStages>
__device__ __forceinline__ void advance_pipeline_group_stage_32x64_nm12_desc_reuse_fixed_shape_stage7_unroll_k(
...
__global__ __launch_bounds__(kThreadsProducerMetadataGroupStage32x64NM12DescReuseFixedShapeStage7UnrollK, 1)
void hybrid_sparse_group_stage_output32x64_nm12_fastpath_desc_reuse_fixed_shape_stage7_unroll_k(
    ...
    constexpr int kActivationBytes =
        kOutputTileMProducerMetadataGroupStage32x64NM12DescReuseFixedShapeStage7UnrollK * kBlock * kBlockM *
    ...
    constexpr int kOutputBytes =
        kOutputTileMProducerMetadataGroupStage32x64NM12DescReuseFixedShapeStage7UnrollK *
        kOutputTileNProducerMetadataGroupStage32x64NM12DescReuseFixedShapeStage7UnrollK * sizeof(__nv_bfloat16);
    ...
    constexpr int tiles_m =
        (kM + kOutputTileMProducerMetadataGroupStage32x64NM12DescReuseFixedShapeStage7UnrollK - 1) /
        kOutputTileMProducerMetadataGroupStage32x64NM12DescReuseFixedShapeStage7UnrollK;
    constexpr int tiles_n =
        (kN + kOutputTileNProducerMetadataGroupStage32x64NM12DescReuseFixedShapeStage7UnrollK - 1) /
        kOutputTileNProducerMetadataGroupStage32x64NM12DescReuseFixedShapeStage7UnrollK;
...
#pragma unroll
    ...
    for (int tile_idx = static_cast<int>(blockIdx.x);
        ...
        const int output_tile_m =
            tile_m * kOutputTileMProducerMetadataGroupStage32x64NM12DescReuseFixedShapeStage7UnrollK;
        const int output_tile_n =
            tile_n * kOutputTileNProducerMetadataGroupStage32x64NM12DescReuseFixedShapeStage7UnrollK;
...
#pragma unroll
                ...
                if (is_leader) {
                    deep_gemm::tma::copy<
                        kBlock * kBlockM,
                        kOutputTileMProducerMetadataGroupStage32x64NM12DescReuseFixedShapeStage7UnrollK, 128,
                        cutlass::bfloat16_t>(
                ...
                advance_pipeline_group_stage_32x64_nm12_desc_reuse_fixed_shape_stage7_unroll_k<kPipelineStages>(
                    producer_stage, producer_phase);
            }
        }

        if (warp < 4) {
            float accumulator[kAccumulatorCountProducerMetadataGroupStage32x64NM12DescReuseFixedShapeStage7UnrollK] = {};
...
#pragma unroll
                for (int i = 0;
                     i < kAccumulatorCountProducerMetadataGroupStage32x64NM12DescReuseFixedShapeStage7UnrollK; ++i)
                    ...
                    for (int k_tile = 0; k_tile < 2; ++k_tile) {
                        ...
                        activation_desc.reg32_[0] =
                            ...
                            (sparse_local_block *
                             ...
                             k_tile * 32) /
                                8;
                        sparse_wgmma_group_stage_32x64_nm12_desc_reuse_fixed_shape_stage7_unroll_k(
                    ...
                    for (int k_tile = 0; k_tile < 4; ++k_tile) {
                        ...
                        activation_desc.reg32_[0] =
                            ...
                            (dense_local_block *
                             ...
                             k_tile * 16) /
                                8;
                        DenseMMAProducerMetadataGroupStage32x64NM12DescReuseFixedShapeStage7UnrollK::wgmma(
...
#pragma unroll
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsProducerMetadataGroupStage32x64NM12DescReuseFixedShapeStage7UnrollK, 0);
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsProducerMetadataGroupStage32x64NM12DescReuseFixedShapeStage7UnrollK, 1);
        }
    }
}
