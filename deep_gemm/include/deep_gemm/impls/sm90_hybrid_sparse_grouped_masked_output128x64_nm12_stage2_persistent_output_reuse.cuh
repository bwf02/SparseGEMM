...
// Two-stage persistent masked grouped 128x64 output tile with stage-0
// epilogue reuse.
...
constexpr int kOutputTileMProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollKStage2PersistentOutputReuse = 128;
constexpr int kOutputTileNProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollKStage2PersistentOutputReuse = 64;
constexpr int kMathThreadsProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollKStage2PersistentOutputReuse = 128;
constexpr int kThreadsProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollKStage2PersistentOutputReuse = 256;
constexpr int kAccumulatorCountProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollKStage2PersistentOutputReuse = 64;
...
__device__ __forceinline__ void wgmma_group_stage_128x64_nm12_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage2_persistent_output_reuse(
...
using DenseMMAProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollKStage2PersistentOutputReuse =
    typename deep_gemm::mma::sm90::BF16MMASelector<128>::type;

template <size_t... I>
__device__ __forceinline__ void sparse_wgmma_group_stage_128x64_nm12_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage2_persistent_output_reuse_impl(
...
__device__ __forceinline__ void sparse_wgmma_group_stage_128x64_nm12_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage2_persistent_output_reuse(
        const unsigned long long desc_a, const unsigned long long desc_b,
        float* accumulator, const unsigned metadata, const bool accumulate) {
    sparse_wgmma_group_stage_128x64_nm12_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage2_persistent_output_reuse_impl(
        desc_a, desc_b, accumulator, metadata, accumulate,
        cute::make_index_sequence<kAccumulatorCountProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollKStage2PersistentOutputReuse>{});
}

template <int kPipelineStages>
__device__ __forceinline__ void advance_pipeline_group_stage_128x64_nm12_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage2_persistent_output_reuse(
...
__global__ __launch_bounds__(kThreadsProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollKStage2PersistentOutputReuse, 1)
void hybrid_sparse_grouped_masked_output128x64_nm12_stage2_persistent_output_reuse(
    ...
    constexpr int kActivationBytes =
        kOutputTileMProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollKStage2PersistentOutputReuse * kBlock * kBlockM *
    ...
    constexpr int tiles_per_expert =
        kMaxM /
        kOutputTileMProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollKStage2PersistentOutputReuse;
    constexpr int tiles_m = kNumExperts * tiles_per_expert;
    constexpr int tiles_n =
        (kN + kOutputTileNProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollKStage2PersistentOutputReuse - 1) /
        kOutputTileNProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollKStage2PersistentOutputReuse;
...
#pragma unroll
    ...
    for (int tile_idx = static_cast<int>(blockIdx.x);
        ...
        const int output_tile_n =
            tile_n * kOutputTileNProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollKStage2PersistentOutputReuse;
...
#pragma unroll
                ...
                if (is_leader) {
                    deep_gemm::tma::copy<
                        kBlock * kBlockM,
                        kOutputTileMProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollKStage2PersistentOutputReuse, 128,
                        cutlass::bfloat16_t>(
                ...
                advance_pipeline_group_stage_128x64_nm12_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage2_persistent_output_reuse<kPipelineStages>(
                    producer_stage, producer_phase);
            }
        }

        if (warp < 4) {
            float accumulator[kAccumulatorCountProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollKStage2PersistentOutputReuse] = {};
...
#pragma unroll
                for (int i = 0;
                     i < kAccumulatorCountProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollKStage2PersistentOutputReuse; ++i)
                ...
                if constexpr (kBlockN == 1 && kBlockM == 2) {
                    ...
                    wgmma_group_stage_128x64_nm12_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage2_persistent_output_reuse(
                        ...
                        for (int k_tile = 0; k_tile < 2; ++k_tile) {
                            ...
                            const auto desc_b =
                                deep_gemm::mma::sm90::make_smem_desc(
                                    ...
                                    0, 1024);
                            sparse_wgmma_group_stage_128x64_nm12_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage2_persistent_output_reuse(
                            ...
                            const auto desc_b =
                                deep_gemm::mma::sm90::make_smem_desc(
                                    ...
                                    static_cast<int>(
                                        cute::GMMA::LayoutType::B128),
                                    0, 1024);
                            DenseMMAProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollKStage2PersistentOutputReuse::wgmma(
                                desc_a.desc_, desc_b.desc_, accumulator,
                                has_accumulator || local_block != 0 ||
                                    k_tile != 0);
                        }
...
#pragma unroll
        ...
        // Stage 0 owns the epilogue buffer. Keep the producer from reusing it
        // for the next persistent tile until warp 0 completes the TMA store.
        __syncthreads();
    }
}
