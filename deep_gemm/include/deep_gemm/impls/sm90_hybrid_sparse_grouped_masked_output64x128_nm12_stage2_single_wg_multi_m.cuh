...
void hybrid_sparse_grouped_masked_output64x128_nm12_stage2_single_wg_multi_m(
    ...
    constexpr int kTilesMPerExpert = kMaxM / kGroupedOutput64x128SingleWGM;
    constexpr int kTilesM = kNumExperts * kTilesMPerExpert;
...
#pragma unroll
    ...
    const int expert = tile_m / kTilesMPerExpert;
    const int local_tile_m = tile_m % kTilesMPerExpert;
    const int block_row_base = tile_n * kWeightRows;
    const int local_m = local_tile_m * kGroupedOutput64x128SingleWGM;
...
#pragma unroll
        ...
        cutlass::arch::NamedBarrier::sync(kGroupedOutput64x128SingleWGMathThreads, 1);
    }
}
