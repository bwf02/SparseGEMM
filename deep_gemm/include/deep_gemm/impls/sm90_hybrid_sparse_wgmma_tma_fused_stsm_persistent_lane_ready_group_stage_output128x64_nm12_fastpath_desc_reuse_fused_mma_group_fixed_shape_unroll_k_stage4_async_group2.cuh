...
void hybrid_sparse_group_stage_output128x64_nm12_fastpath_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage4_async_group2(
    ...
    constexpr int tiles_m =
        (kM + kOutputTileMProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollKStage4AsyncGroup2 - 1) /
        kOutputTileMProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollKStage4AsyncGroup2;
...
#pragma unroll
    ...
    if (tile_idx < total_tiles) {
        ...
        const int output_tile_m =
            tile_m * kOutputTileMProducerMetadataGroupStage128x64NM12DescReuseFusedMMAGroupFixedShapeUnrollKStage4AsyncGroup2;
