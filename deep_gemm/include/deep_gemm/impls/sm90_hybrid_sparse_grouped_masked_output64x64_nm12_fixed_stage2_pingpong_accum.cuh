...
// Fixed-shape masked grouped 64x64 full-grid kernel.
...
void hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage2_pingpong_accum(
...
#pragma unroll
        ...
        if (warp < 4) {
            ...
            float odd_accumulator[kAccumulatorCountProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupConstexprDescBranchGroupFullGrid] = {};
