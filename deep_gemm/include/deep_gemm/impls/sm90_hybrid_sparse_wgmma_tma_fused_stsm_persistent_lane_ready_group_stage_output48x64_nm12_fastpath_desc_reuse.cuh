...
constexpr int kOutputTileMProducerMetadataGroupStage48x64NM12DescReuse = 48;
constexpr int kOutputTileNProducerMetadataGroupStage48x64NM12DescReuse = 64;
constexpr int kMathThreadsProducerMetadataGroupStage48x64NM12DescReuse = 128;
constexpr int kThreadsProducerMetadataGroupStage48x64NM12DescReuse = 256;
constexpr int kAccumulatorCountProducerMetadataGroupStage48x64NM12DescReuse = 24;

using DenseMMAProducerMetadataGroupStage48x64NM12DescReuse =
    typename deep_gemm::mma::sm90::BF16MMASelector<48>::type;

template <size_t... I>
__device__ __forceinline__ void sparse_wgmma_group_stage_48x64_nm12_desc_reuse_impl(
...
__device__ __forceinline__ void sparse_wgmma_group_stage_48x64_nm12_desc_reuse(
        const unsigned long long desc_a, const unsigned long long desc_b,
        float* accumulator, const unsigned metadata, const bool accumulate) {
    sparse_wgmma_group_stage_48x64_nm12_desc_reuse_impl(
        desc_a, desc_b, accumulator, metadata, accumulate,
        cute::make_index_sequence<kAccumulatorCountProducerMetadataGroupStage48x64NM12DescReuse>{});
}

template <int kPipelineStages>
__device__ __forceinline__ void advance_pipeline_group_stage_48x64_nm12_desc_reuse(
...
__global__ __launch_bounds__(kThreadsProducerMetadataGroupStage48x64NM12DescReuse, 1)
void hybrid_sparse_group_stage_output48x64_nm12_fastpath_desc_reuse(
    ...
    constexpr int kActivationBytes =
        kOutputTileMProducerMetadataGroupStage48x64NM12DescReuse * kBlock * kBlockM *
    ...
    constexpr int kOutputBytes =
        kOutputTileMProducerMetadataGroupStage48x64NM12DescReuse *
        kOutputTileNProducerMetadataGroupStage48x64NM12DescReuse * sizeof(__nv_bfloat16);
    ...
    const int tiles_m =
        (m + kOutputTileMProducerMetadataGroupStage48x64NM12DescReuse - 1) /
        kOutputTileMProducerMetadataGroupStage48x64NM12DescReuse;
    const int tiles_n =
        (n + kOutputTileNProducerMetadataGroupStage48x64NM12DescReuse - 1) /
        kOutputTileNProducerMetadataGroupStage48x64NM12DescReuse;
...
#pragma unroll
    ...
    for (int tile_idx = static_cast<int>(blockIdx.x);
        ...
        const int output_tile_m =
            tile_m * kOutputTileMProducerMetadataGroupStage48x64NM12DescReuse;
        const int output_tile_n =
            tile_n * kOutputTileNProducerMetadataGroupStage48x64NM12DescReuse;
...
#pragma unroll
                ...
                if (is_leader) {
                    deep_gemm::tma::copy<
                        kBlock * kBlockM,
                        kOutputTileMProducerMetadataGroupStage48x64NM12DescReuse, 128,
                        cutlass::bfloat16_t>(
                ...
                advance_pipeline_group_stage_48x64_nm12_desc_reuse<kPipelineStages>(
                    producer_stage, producer_phase);
            }
        }

        if (warp < 4) {
            float accumulator[kAccumulatorCountProducerMetadataGroupStage48x64NM12DescReuse] = {};
...
#pragma unroll
                for (int i = 0;
                     i < kAccumulatorCountProducerMetadataGroupStage48x64NM12DescReuse; ++i)
                    ...
                    for (int k_tile = 0; k_tile < 2; ++k_tile) {
                        ...
                        activation_desc.reg32_[0] =
                            ...
                            (sparse_local_block *
                             ...
                             k_tile * 32) /
                                8;
                        sparse_wgmma_group_stage_48x64_nm12_desc_reuse(
                    ...
                    for (int k_tile = 0; k_tile < 4; ++k_tile) {
                        ...
                        activation_desc.reg32_[0] =
                            ...
                            (dense_local_block *
                             ...
                             k_tile * 16) /
                                8;
                        DenseMMAProducerMetadataGroupStage48x64NM12DescReuse::wgmma(
...
#pragma unroll
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsProducerMetadataGroupStage48x64NM12DescReuse, 0);
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsProducerMetadataGroupStage48x64NM12DescReuse, 1);
        }
    }
}
