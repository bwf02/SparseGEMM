...
constexpr int kOutputTileMProducerMetadataGroupStage64x64 = 64;
constexpr int kOutputTileNProducerMetadataGroupStage64x64 = 64;
constexpr int kMathThreadsProducerMetadataGroupStage64x64 = 128;
constexpr int kThreadsProducerMetadataGroupStage64x64 = 256;
constexpr int kAccumulatorCountProducerMetadataGroupStage64x64 = 32;

using DenseMMAProducerMetadataGroupStage64x64 =
    typename deep_gemm::mma::sm90::BF16MMASelector<64>::type;

template <size_t... I>
__device__ __forceinline__ void sparse_wgmma_group_stage_64x64_impl(
...
__device__ __forceinline__ void sparse_wgmma_group_stage_64x64(
        const unsigned long long desc_a, const unsigned long long desc_b,
        float* accumulator, const unsigned metadata, const bool accumulate) {
    sparse_wgmma_group_stage_64x64_impl(
        desc_a, desc_b, accumulator, metadata, accumulate,
        cute::make_index_sequence<kAccumulatorCountProducerMetadataGroupStage64x64>{});
}

template <int kPipelineStages>
__device__ __forceinline__ void advance_pipeline_group_stage_64x64(
...
void hybrid_sparse_group_stage_output64x64(
    ...
    constexpr int kOutputBytes =
        ...
        kOutputTileNProducerMetadataGroupStage64x64 * sizeof(__nv_bfloat16);
    ...
    const int tiles_m =
        (m + kOutputTileMProducerMetadataGroupStage64x64 - 1) /
        kOutputTileMProducerMetadataGroupStage64x64;
    const int tiles_n =
...
#pragma unroll
    ...
    for (int tile_idx = static_cast<int>(blockIdx.x);
        ...
        const int output_tile_m =
            tile_m * kOutputTileMProducerMetadataGroupStage64x64;
...
#pragma unroll
        ...
        if (warp < 4) {
            float accumulator[kAccumulatorCountProducerMetadataGroupStage64x64] = {};
...
#pragma unroll
                for (int i = 0;
                     i < kAccumulatorCountProducerMetadataGroupStage64x64; ++i)
