...
constexpr int kOutputTileMProducerMetadataGroupStage48x64NM12Compact = 48;
constexpr int kOutputTileNProducerMetadataGroupStage48x64NM12Compact = 64;
constexpr int kMathThreadsProducerMetadataGroupStage48x64NM12Compact = 128;
constexpr int kThreadsProducerMetadataGroupStage48x64NM12Compact = 160;
constexpr int kAccumulatorCountProducerMetadataGroupStage48x64NM12Compact = 24;

using DenseMMAProducerMetadataGroupStage48x64NM12Compact =
    typename deep_gemm::mma::sm90::BF16MMASelector<48>::type;

template <size_t... I>
__device__ __forceinline__ void sparse_wgmma_group_stage_48x64_nm12_compact_impl(
...
__device__ __forceinline__ void sparse_wgmma_group_stage_48x64_nm12_compact(
        const unsigned long long desc_a, const unsigned long long desc_b,
        float* accumulator, const unsigned metadata, const bool accumulate) {
    sparse_wgmma_group_stage_48x64_nm12_compact_impl(
        desc_a, desc_b, accumulator, metadata, accumulate,
        cute::make_index_sequence<kAccumulatorCountProducerMetadataGroupStage48x64NM12Compact>{});
}

template <int kPipelineStages>
__device__ __forceinline__ void advance_pipeline_group_stage_48x64_nm12_compact(
...
__global__ __launch_bounds__(kThreadsProducerMetadataGroupStage48x64NM12Compact, 1)
void hybrid_sparse_group_stage_output48x64_nm12_fastpath_compact(
    ...
    constexpr int kActivationBytes =
        kOutputTileMProducerMetadataGroupStage48x64NM12Compact * kBlock * kBlockM *
    ...
    constexpr int kOutputBytes =
        kOutputTileMProducerMetadataGroupStage48x64NM12Compact *
        kOutputTileNProducerMetadataGroupStage48x64NM12Compact * sizeof(__nv_bfloat16);
    ...
    const int tiles_m =
        (m + kOutputTileMProducerMetadataGroupStage48x64NM12Compact - 1) /
        kOutputTileMProducerMetadataGroupStage48x64NM12Compact;
    const int tiles_n =
        (n + kOutputTileNProducerMetadataGroupStage48x64NM12Compact - 1) /
        kOutputTileNProducerMetadataGroupStage48x64NM12Compact;
...
#pragma unroll
    ...
    for (int tile_idx = static_cast<int>(blockIdx.x);
        ...
        const int output_tile_m =
            tile_m * kOutputTileMProducerMetadataGroupStage48x64NM12Compact;
        const int output_tile_n =
            tile_n * kOutputTileNProducerMetadataGroupStage48x64NM12Compact;
...
#pragma unroll
                ...
                if (is_leader) {
                    deep_gemm::tma::copy<
                        kBlock * kBlockM,
                        kOutputTileMProducerMetadataGroupStage48x64NM12Compact, 128,
                        cutlass::bfloat16_t>(
                ...
                advance_pipeline_group_stage_48x64_nm12_compact<kPipelineStages>(
                    producer_stage, producer_phase);
            }
        }

        if (warp < 4) {
            float accumulator[kAccumulatorCountProducerMetadataGroupStage48x64NM12Compact] = {};
...
#pragma unroll
                for (int i = 0;
                     i < kAccumulatorCountProducerMetadataGroupStage48x64NM12Compact; ++i)
                    ...
                    for (int k_tile = 0; k_tile < 2; ++k_tile) {
                        ...
                        const auto desc_a =
                            deep_gemm::mma::sm90::make_smem_desc(
                                smem_sparse(consumer_stage) + k_tile * 16,
                                static_cast<int>(
                        ...
                        const auto desc_b =
                            deep_gemm::mma::sm90::make_smem_desc(
                                ...
                                0, 1024);
                        sparse_wgmma_group_stage_48x64_nm12_compact(
...
#pragma unroll
                    for (int k_tile = 0; k_tile < 4; ++k_tile) {
                        const auto desc_a =
                            deep_gemm::mma::sm90::make_smem_desc(
                                smem_dense(consumer_stage) + k_tile * 16,
                                static_cast<int>(
                                    cute::GMMA::LayoutType::B128),
                                0, 1024);
                        const auto desc_b =
                            deep_gemm::mma::sm90::make_smem_desc(
                                ...
                                static_cast<int>(
                                    cute::GMMA::LayoutType::B128),
                                0, 1024);
                        DenseMMAProducerMetadataGroupStage48x64NM12Compact::wgmma(
...
#pragma unroll
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsProducerMetadataGroupStage48x64NM12Compact, 0);
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsProducerMetadataGroupStage48x64NM12Compact, 1);
        }
    }
}
