...
// Fixed-shape masked grouped 64x64 kernel with three TMA stages and
// two K stages per WGMMA commit group.
...
void hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage3_merge_k2(
    ...
    static_assert(block_groups % 2 == 0);
...
#pragma unroll
                            ...
                            constexpr int kPreviousStage =
                                (kGroup - 1) % kPipelineStages;
                            release_stage(
                                &empty_barrier[kPreviousStage]);
