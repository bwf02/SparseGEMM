...
constexpr int kOutputTileMProducerMetadataGroupStage88x64NM12DescReuse = 88;
constexpr int kOutputTileNProducerMetadataGroupStage88x64NM12DescReuse = 64;
constexpr int kMathThreadsProducerMetadataGroupStage88x64NM12DescReuse = 128;
constexpr int kThreadsProducerMetadataGroupStage88x64NM12DescReuse = 256;
constexpr int kAccumulatorCountProducerMetadataGroupStage88x64NM12DescReuse = 44;

using DenseMMAProducerMetadataGroupStage88x64NM12DescReuse =
    typename deep_gemm::mma::sm90::BF16MMASelector<88>::type;

template <size_t... I>
__device__ __forceinline__ void sparse_wgmma_group_stage_88x64_nm12_desc_reuse_impl(
    ...
    using SparseMMA = cute::SM90::GMMA::SPARSE::
        GMMA_64x88x32_F32BF16BF16_SS<cute::GMMA::Major::K,
                                     cute::GMMA::Major::K>;
    SparseMMA::fma(
...
__device__ __forceinline__ void sparse_wgmma_group_stage_88x64_nm12_desc_reuse(
        const unsigned long long desc_a, const unsigned long long desc_b,
        float* accumulator, const unsigned metadata, const bool accumulate) {
    sparse_wgmma_group_stage_88x64_nm12_desc_reuse_impl(
        desc_a, desc_b, accumulator, metadata, accumulate,
        cute::make_index_sequence<kAccumulatorCountProducerMetadataGroupStage88x64NM12DescReuse>{});
}

template <int kPipelineStages>
__device__ __forceinline__ void advance_pipeline_group_stage_88x64_nm12_desc_reuse(
...
__global__ __launch_bounds__(kThreadsProducerMetadataGroupStage88x64NM12DescReuse, 1)
void hybrid_sparse_group_stage_output88x64_nm12_fastpath_desc_reuse(
    ...
    constexpr int kActivationBytes =
        kOutputTileMProducerMetadataGroupStage88x64NM12DescReuse * kBlock * kBlockM *
    ...
    constexpr int kOutputBytes =
        kOutputTileMProducerMetadataGroupStage88x64NM12DescReuse *
        kOutputTileNProducerMetadataGroupStage88x64NM12DescReuse * sizeof(__nv_bfloat16);
    ...
    const int tiles_m =
        (m + kOutputTileMProducerMetadataGroupStage88x64NM12DescReuse - 1) /
        kOutputTileMProducerMetadataGroupStage88x64NM12DescReuse;
    const int tiles_n =
        (n + kOutputTileNProducerMetadataGroupStage88x64NM12DescReuse - 1) /
        kOutputTileNProducerMetadataGroupStage88x64NM12DescReuse;
...
#pragma unroll
    ...
    for (int tile_idx = static_cast<int>(blockIdx.x);
        ...
        const int output_tile_m =
            tile_m * kOutputTileMProducerMetadataGroupStage88x64NM12DescReuse;
        const int output_tile_n =
            tile_n * kOutputTileNProducerMetadataGroupStage88x64NM12DescReuse;
...
#pragma unroll
                ...
                if (is_leader) {
                    deep_gemm::tma::copy<
                        kBlock * kBlockM,
                        kOutputTileMProducerMetadataGroupStage88x64NM12DescReuse, 128,
                        cutlass::bfloat16_t>(
                ...
                advance_pipeline_group_stage_88x64_nm12_desc_reuse<kPipelineStages>(
                    producer_stage, producer_phase);
            }
        }

        if (warp < 4) {
            float accumulator[kAccumulatorCountProducerMetadataGroupStage88x64NM12DescReuse] = {};
...
#pragma unroll
                for (int i = 0;
                     i < kAccumulatorCountProducerMetadataGroupStage88x64NM12DescReuse; ++i)
                    ...
                    for (int k_tile = 0; k_tile < 2; ++k_tile) {
                        ...
                        activation_desc.reg32_[0] =
                            ...
                            (sparse_local_block *
                             ...
                             k_tile * 32) /
                                8;
                        sparse_wgmma_group_stage_88x64_nm12_desc_reuse(
                    ...
                    for (int k_tile = 0; k_tile < 4; ++k_tile) {
                        ...
                        activation_desc.reg32_[0] =
                            ...
                            (dense_local_block *
                             ...
                             k_tile * 16) /
                                8;
                        DenseMMAProducerMetadataGroupStage88x64NM12DescReuse::wgmma(
...
#pragma unroll
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsProducerMetadataGroupStage88x64NM12DescReuse, 0);
            ...
            cutlass::arch::NamedBarrier::sync(
                kMathThreadsProducerMetadataGroupStage88x64NM12DescReuse, 1);
        }
    }
}
