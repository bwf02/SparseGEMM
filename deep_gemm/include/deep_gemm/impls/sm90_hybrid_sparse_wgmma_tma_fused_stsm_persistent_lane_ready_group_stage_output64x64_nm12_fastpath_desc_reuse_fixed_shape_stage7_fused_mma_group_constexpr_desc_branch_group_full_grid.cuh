...
void hybrid_sparse_group_stage_output64x64_nm12_fastpath_desc_reuse_fixed_shape_stage7_fused_mma_group_constexpr_desc_branch_group_full_grid(
    ...
    constexpr int tiles_m =
        (kM + kOutputTileMProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupConstexprDescBranchGroupFullGrid - 1) /
        kOutputTileMProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupConstexprDescBranchGroupFullGrid;
...
#pragma unroll
    ...
    for (int tile_idx = static_cast<int>(blockIdx.x);
        ...
        const int output_tile_m =
            tile_m * kOutputTileMProducerMetadataGroupStage64x64NM12DescReuseFixedShapeStage7FusedMMAGroupConstexprDescBranchGroupFullGrid;
