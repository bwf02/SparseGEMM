...
// Hybrid sparse 128x32 weight blocks with a three-stage TMA pipeline.
...
void hybrid_sparse_dense_wgmma_tma_block128x32_stage3(
...
template <int = 0>
__global__ __launch_bounds__(kThreads, 1)
void hybrid_sparse_2_4_wgmma_tma_block128x32_stage3(
...
template <int = 0>
__global__ void hybrid_sparse_reduce_wgmma_tma_block128x32_stage3(
