...
template <int kBlockN, int kBlockM, int kPipelineStages,
          int kNumExperts, int kTotalM, int kMAlignment, int kN, int kK>
...
void hybrid_sparse_grouped_contiguous_output64x128_nm12_stage2_single_wg(
    ...
    constexpr int kTilesM = kTotalM / kGroupedContiguousOutput64x128SingleWGM;
