...
class SM90HybridSparseGroupedMaskedOutput64x64NM12Stage3TwoCTARuntimeKRuntime final:
        public LaunchRuntime<SM90HybridSparseGroupedMaskedOutput64x64NM12Stage3TwoCTARuntimeKRuntime> {
public:
    struct Args {
        void* block_selector;
    ...
    static std::string generate_impl(const Args& args) {
        return fmt::format(R"(
#include <deep_gemm/impls/sm90_hybrid_sparse_grouped_masked_output64x64_nm12_stage3_two_cta_runtime_k.cuh>

static void __instantiate_kernel() {{
    auto ptr = reinterpret_cast<void*>(
        &hybrid_sparse_grouped_masked_output64x64_nm12_stage3_two_cta_runtime_k<
            {}, {}, {}, {}, {}, {}, {}>);
    (void)ptr;
}}
)",
...
static void sm90_hybrid_block_sparse_bf16_grouped_masked_output64x64_nm12_stage3_two_cta_runtime_k(
    ...
    const auto args = SM90HybridSparseGroupedMaskedOutput64x64NM12Stage3TwoCTARuntimeKRuntime::Args {
    ...
    const auto runtime = compiler->build(
        "sm90_hybrid_sparse_grouped_masked_output64x64_nm12_stage3_two_cta_runtime_k",
        SM90HybridSparseGroupedMaskedOutput64x64NM12Stage3TwoCTARuntimeKRuntime::generate(args));
    SM90HybridSparseGroupedMaskedOutput64x64NM12Stage3TwoCTARuntimeKRuntime::launch(runtime, args);
}
