...
class SM90HybridSparseGroupedMaskedOutput64x128NM12Stage2Cluster2Runtime final:
        public LaunchRuntime<SM90HybridSparseGroupedMaskedOutput64x128NM12Stage2Cluster2Runtime> {
public:
    struct Args {
        void* block_selector;
    ...
    static std::string generate_impl(const Args& args) {
        return fmt::format(R"(
#include <deep_gemm/impls/sm90_hybrid_sparse_grouped_masked_output64x128_nm12_stage2_cluster2.cuh>

static void __instantiate_kernel() {{
    auto ptr = reinterpret_cast<void*>(
        &hybrid_sparse_grouped_masked_output64x128_nm12_stage2_cluster2<
            {}, {}, {}, {}, {}, {}, {}>);
    (void)ptr;
}}
...
static void sm90_hybrid_block_sparse_bf16_grouped_masked_output64x128_nm12_stage2_cluster2(
    ...
    const auto args = SM90HybridSparseGroupedMaskedOutput64x128NM12Stage2Cluster2Runtime::Args {
        ...
        .launch_args = LaunchArgs(total_tiles, 384, smem_bytes, 2),
    };
    const auto runtime = compiler->build(
        "sm90_hybrid_sparse_grouped_masked_output64x128_nm12_stage2_cluster2",
        SM90HybridSparseGroupedMaskedOutput64x128NM12Stage2Cluster2Runtime::generate(args));
    SM90HybridSparseGroupedMaskedOutput64x128NM12Stage2Cluster2Runtime::launch(runtime, args);
}
