...
class SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage3MergeK2Runtime final:
        public LaunchRuntime<SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage3MergeK2Runtime> {
public:
    struct Args {
        void* block_selector;
    ...
    static std::string generate_impl(const Args& args) {
        return fmt::format(R"(
#include <deep_gemm/impls/sm90_hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage3_merge_k2.cuh>

static void __instantiate_kernel() {{
    auto ptr = reinterpret_cast<void*>(
        &hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage3_merge_k2<
            {}, {}, {}, {}, {}, {}, {}>);
    (void)ptr;
}}
)",
...
static void sm90_hybrid_block_sparse_bf16_grouped_masked_output64x64_nm12_fixed_stage3_merge_k2(
    ...
    const auto args = SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage3MergeK2Runtime::Args {
    ...
    const auto runtime = compiler->build(
        "sm90_hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage3_merge_k2",
        SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage3MergeK2Runtime::generate(args));
    SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage3MergeK2Runtime::launch(runtime, args);
}
