...
class SM90HybridSparseGroupedMaskedOutput64x64NM12FixedFullGridRuntime final:
        public LaunchRuntime<SM90HybridSparseGroupedMaskedOutput64x64NM12FixedFullGridRuntime> {
public:
    struct Args {
        void* block_selector;
...
static void sm90_hybrid_block_sparse_bf16_grouped_masked_output64x64_nm12_fixed_full_grid(
    ...
    const auto args = SM90HybridSparseGroupedMaskedOutput64x64NM12FixedFullGridRuntime::Args {
    ...
    const auto runtime = compiler->build(
        "sm90_hybrid_sparse_grouped_masked_output64x64_nm12_fixed_full_grid",
        SM90HybridSparseGroupedMaskedOutput64x64NM12FixedFullGridRuntime::generate(args));
    SM90HybridSparseGroupedMaskedOutput64x64NM12FixedFullGridRuntime::launch(runtime, args);
}
