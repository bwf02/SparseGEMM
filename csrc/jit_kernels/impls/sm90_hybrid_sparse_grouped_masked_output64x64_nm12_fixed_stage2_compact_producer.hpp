...
class SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage2CompactProducerRuntime final:
        public LaunchRuntime<SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage2CompactProducerRuntime> {
public:
    struct Args {
        void* block_selector;
    ...
    static std::string generate_impl(const Args& args) {
        return fmt::format(R"(
#include <deep_gemm/impls/sm90_hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage2_compact_producer.cuh>

static void __instantiate_kernel() {{
    auto ptr = reinterpret_cast<void*>(
        &hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage2_compact_producer<
            {}, {}, {}, {}, {}, {}, {}>);
    (void)ptr;
}}
)",
...
static void sm90_hybrid_block_sparse_bf16_grouped_masked_output64x64_nm12_fixed_stage2_compact_producer(
    ...
    const auto args = SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage2CompactProducerRuntime::Args {
        ...
        .launch_args = LaunchArgs(total_tiles, 192, smem_bytes),
    };
    const auto runtime = compiler->build(
        "sm90_hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage2_compact_producer",
        SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage2CompactProducerRuntime::generate(args));
    SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage2CompactProducerRuntime::launch(runtime, args);
}
