...
class SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage3MaskedEpilogueRuntime final:
        public LaunchRuntime<SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage3MaskedEpilogueRuntime> {
public:
    struct Args {
        void* block_selector;
    ...
    static std::string generate_impl(const Args& args) {
        return fmt::format(R"(
#include <deep_gemm/impls/sm90_hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage3_masked_epilogue.cuh>

static void __instantiate_kernel() {{
    auto ptr = reinterpret_cast<void*>(
        &hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage3_masked_epilogue<
            {}, {}, {}, {}, {}, {}, {}>);
    (void)ptr;
}}
)",
            args.block_n, args.block_m,
            3, args.num_experts, args.max_m, args.n, args.k);
    }
...
static void sm90_hybrid_block_sparse_bf16_grouped_masked_output64x64_nm12_fixed_stage3_masked_epilogue(
    ...
    const auto args = SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage3MaskedEpilogueRuntime::Args {
    ...
    const auto runtime = compiler->build(
        "sm90_hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage3_masked_epilogue",
        SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage3MaskedEpilogueRuntime::generate(args));
    SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage3MaskedEpilogueRuntime::launch(runtime, args);
}
