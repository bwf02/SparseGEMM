...
class SM90HybridSparseGroupedMaskedOutput64x64NM12Stage2Cluster2MaskedEpilogueRuntime final:
        public LaunchRuntime<SM90HybridSparseGroupedMaskedOutput64x64NM12Stage2Cluster2MaskedEpilogueRuntime> {
public:
    struct Args {
        void* block_selector;
    ...
    static std::string generate_impl(const Args& args) {
        return fmt::format(R"(
#include <deep_gemm/impls/sm90_hybrid_sparse_grouped_masked_output64x64_nm12_stage2_cluster2_masked_epilogue.cuh>

static void __instantiate_kernel() {{
    auto ptr = reinterpret_cast<void*>(
        &hybrid_sparse_grouped_masked_output64x64_nm12_stage2_cluster2_masked_epilogue<
            {}, {}, {}, {}, {}, {}, {}>);
    (void)ptr;
}}
)",
...
static void sm90_hybrid_block_sparse_bf16_grouped_masked_output64x64_nm12_stage2_cluster2_masked_epilogue(
    ...
    DG_HOST_ASSERT(max_m == 64 and n % 128 == 0);
    ...
    const auto args = SM90HybridSparseGroupedMaskedOutput64x64NM12Stage2Cluster2MaskedEpilogueRuntime::Args {
        ...
        .launch_args = LaunchArgs(total_tiles, 256, smem_bytes, 2),
    };
    const auto runtime = compiler->build(
        "sm90_hybrid_sparse_grouped_masked_output64x64_nm12_stage2_cluster2_masked_epilogue",
        SM90HybridSparseGroupedMaskedOutput64x64NM12Stage2Cluster2MaskedEpilogueRuntime::generate(args));
    SM90HybridSparseGroupedMaskedOutput64x64NM12Stage2Cluster2MaskedEpilogueRuntime::launch(runtime, args);
}
