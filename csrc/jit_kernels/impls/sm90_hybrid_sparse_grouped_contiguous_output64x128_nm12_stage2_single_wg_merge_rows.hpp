...
class SM90HybridSparseGroupedContiguousOutput64x128NM12Stage2SingleWGMergeRowsRuntime final:
        public LaunchRuntime<SM90HybridSparseGroupedContiguousOutput64x128NM12Stage2SingleWGMergeRowsRuntime> {
public:
    struct Args {
        void* block_selector;
    ...
    static std::string generate_impl(const Args& args) {
        return fmt::format(R"(
#include <deep_gemm/impls/sm90_hybrid_sparse_grouped_contiguous_output64x128_nm12_stage2_single_wg_merge_rows.cuh>

static void __instantiate_kernel() {{
    auto ptr = reinterpret_cast<void*>(
        &hybrid_sparse_grouped_contiguous_output64x128_nm12_stage2_single_wg_merge_rows<
            {}, {}, {}, {}, {}, {}, {}>);
    (void)ptr;
}}
...
static void sm90_hybrid_block_sparse_bf16_grouped_contiguous_output64x128_nm12_stage2_single_wg_merge_rows(
    ...
    const auto args = SM90HybridSparseGroupedContiguousOutput64x128NM12Stage2SingleWGMergeRowsRuntime::Args {
    ...
    const auto runtime = compiler->build(
        "sm90_hybrid_sparse_grouped_contiguous_output64x128_nm12_stage2_single_wg_merge_rows",
        SM90HybridSparseGroupedContiguousOutput64x128NM12Stage2SingleWGMergeRowsRuntime::generate(args));
    SM90HybridSparseGroupedContiguousOutput64x128NM12Stage2SingleWGMergeRowsRuntime::launch(runtime, args);
}
