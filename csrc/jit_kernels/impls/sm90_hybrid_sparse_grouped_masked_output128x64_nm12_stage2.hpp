...
class SM90HybridSparseGroupedMaskedOutput128x64NM12Stage2Runtime final:
        public LaunchRuntime<SM90HybridSparseGroupedMaskedOutput128x64NM12Stage2Runtime> {
public:
    struct Args {
        void* block_selector;
...
static void sm90_hybrid_block_sparse_bf16_grouped_masked_output128x64_nm12_stage2(
    ...
    const auto args =
        SM90HybridSparseGroupedMaskedOutput128x64NM12Stage2Runtime::Args {
    ...
    const auto runtime = compiler->build(
        "sm90_hybrid_sparse_grouped_masked_output128x64_nm12_stage2",
        SM90HybridSparseGroupedMaskedOutput128x64NM12Stage2Runtime::generate(args));
    SM90HybridSparseGroupedMaskedOutput128x64NM12Stage2Runtime::launch(runtime, args);
}
