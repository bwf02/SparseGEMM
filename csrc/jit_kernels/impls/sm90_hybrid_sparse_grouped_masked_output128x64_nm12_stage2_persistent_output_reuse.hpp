...
class SM90HybridSparseGroupedMaskedOutput128x64NM12Stage2PersistentOutputReuseRuntime final:
        public LaunchRuntime<SM90HybridSparseGroupedMaskedOutput128x64NM12Stage2PersistentOutputReuseRuntime> {
public:
    struct Args {
        void* block_selector;
    ...
    static std::string generate_impl(const Args& args) {
        return fmt::format(R"(
#include <deep_gemm/impls/sm90_hybrid_sparse_grouped_masked_output128x64_nm12_stage2_persistent_output_reuse.cuh>

static void __instantiate_kernel() {{
    auto ptr = reinterpret_cast<void*>(
        &hybrid_sparse_grouped_masked_output128x64_nm12_stage2_persistent_output_reuse<
            {}, {}, {}, {}, {}, {}, {}>);
    (void)ptr;
}}
)",
...
static void sm90_hybrid_block_sparse_bf16_grouped_masked_output128x64_nm12_stage2_persistent_output_reuse(
    ...
    const auto args =
        SM90HybridSparseGroupedMaskedOutput128x64NM12Stage2PersistentOutputReuseRuntime::Args {
    ...
    const auto runtime = compiler->build(
        "sm90_hybrid_sparse_grouped_masked_output128x64_nm12_stage2_persistent_output_reuse",
        SM90HybridSparseGroupedMaskedOutput128x64NM12Stage2PersistentOutputReuseRuntime::generate(args));
    SM90HybridSparseGroupedMaskedOutput128x64NM12Stage2PersistentOutputReuseRuntime::launch(runtime, args);
}
