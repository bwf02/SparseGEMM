...
public:
    ...
    static const char* kernel_symbol(const HybridSparseWgmmaTma128x64Kernel kernel) {
        switch (kernel) {
            case HybridSparseWgmmaTma128x64Kernel::Dense:
                return "hybrid_sparse_dense_wgmma_tma_128x64";
            case HybridSparseWgmmaTma128x64Kernel::Sparse:
                return "hybrid_sparse_2_4_wgmma_tma_128x64";
            case HybridSparseWgmmaTma128x64Kernel::Reduce:
                return "hybrid_sparse_reduce_wgmma_tma_128x64";
        }
    ...
    static std::string generate_impl(const Args& args) {
        ...
        return std::string(R"(
#include <deep_gemm/impls/sm90_hybrid_sparse_wgmma_tma_128x64.cuh>
