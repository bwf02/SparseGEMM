...
class SM90HybridSparseGroupedContiguousOutput64x128NM12Stage2SingleWGAsyncK2Runtime final:
        public LaunchRuntime<SM90HybridSparseGroupedContiguousOutput64x128NM12Stage2SingleWGAsyncK2Runtime> {
public:
    struct Args {
        void* block_selector;
    ...
    static std::string generate_impl(const Args& args) {
        return fmt::format(R"(
#include <deep_gemm/impls/sm90_hybrid_sparse_grouped_contiguous_output64x128_nm12_stage2_single_wg_async_k2.cuh>

static void __instantiate_kernel() {{
    auto ptr = reinterpret_cast<void*>(
        &hybrid_sparse_grouped_contiguous_output64x128_nm12_stage2_single_wg_async_k2<
            {}, {}, {}, {}, {}, {}, {}>);
    (void)ptr;
}}
...
static void sm90_hybrid_block_sparse_bf16_grouped_contiguous_output64x128_nm12_stage2_single_wg_async_k2(
    ...
    const auto args = SM90HybridSparseGroupedContiguousOutput64x128NM12Stage2SingleWGAsyncK2Runtime::Args {
    ...
    const auto runtime = compiler->build(
        "sm90_hybrid_sparse_grouped_contiguous_output64x128_nm12_stage2_single_wg_async_k2",
        SM90HybridSparseGroupedContiguousOutput64x128NM12Stage2SingleWGAsyncK2Runtime::generate(args));
    SM90HybridSparseGroupedContiguousOutput64x128NM12Stage2SingleWGAsyncK2Runtime::launch(runtime, args);
}
