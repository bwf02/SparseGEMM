...
class SM90HybridSparseOutput128x64StageKindRuntime final:
        public LaunchRuntime<SM90HybridSparseOutput128x64StageKindRuntime> {
public:
    using Args =
...
static void sm90_hybrid_block_sparse_bf16_gemm_output128x64_stage_kind(
    ...
    const auto args = SM90HybridSparseOutput128x64StageKindRuntime::Args {
    ...
    const auto runtime = compiler->build(
        "sm90_hybrid_sparse_output128x64_stage_kind",
        SM90HybridSparseOutput128x64StageKindRuntime::generate(args));
    SM90HybridSparseOutput128x64StageKindRuntime::launch(runtime, args);
}
