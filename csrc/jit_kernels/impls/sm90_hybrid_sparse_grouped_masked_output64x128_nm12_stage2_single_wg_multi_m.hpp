...
class SM90HybridSparseGroupedMaskedOutput64x128NM12Stage2SingleWGMultiMRuntime final:
        public LaunchRuntime<SM90HybridSparseGroupedMaskedOutput64x128NM12Stage2SingleWGMultiMRuntime> {
public:
    struct Args {
        void* block_selector;
    ...
    static std::string generate_impl(const Args& args) {
        return fmt::format(R"(
#include <deep_gemm/impls/sm90_hybrid_sparse_grouped_masked_output64x128_nm12_stage2_single_wg_multi_m.cuh>

static void __instantiate_kernel() {{
    auto ptr = reinterpret_cast<void*>(
        &hybrid_sparse_grouped_masked_output64x128_nm12_stage2_single_wg_multi_m<
            {}, {}, {}, {}, {}, {}, {}>);
    (void)ptr;
}}
...
static void sm90_hybrid_block_sparse_bf16_grouped_masked_output64x128_nm12_stage2_single_wg_multi_m(
    ...
    DG_HOST_ASSERT(block_n == 1 and block_m == 2 and max_m % 64 == 0);
    ...
    const int total_tiles = num_experts * (max_m / 64) * (n / 128);
    const auto args = SM90HybridSparseGroupedMaskedOutput64x128NM12Stage2SingleWGMultiMRuntime::Args {
    ...
    const auto runtime = compiler->build(
        "sm90_hybrid_sparse_grouped_masked_output64x128_nm12_stage2_single_wg_multi_m",
        SM90HybridSparseGroupedMaskedOutput64x128NM12Stage2SingleWGMultiMRuntime::generate(args));
    SM90HybridSparseGroupedMaskedOutput64x128NM12Stage2SingleWGMultiMRuntime::launch(runtime, args);
}
