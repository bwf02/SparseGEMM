...
class SM90HybridSparseGroupedMaskedOutput128x64NM12Stage4FullTileEpilogueRuntime final:
        public LaunchRuntime<SM90HybridSparseGroupedMaskedOutput128x64NM12Stage4FullTileEpilogueRuntime> {
public:
    struct Args {
        void* block_selector;
    ...
    static std::string generate_impl(const Args& args) {
        return fmt::format(R"(
#include <deep_gemm/impls/sm90_hybrid_sparse_grouped_masked_output128x64_nm12_stage4_full_tile_epilogue.cuh>

static void __instantiate_kernel() {{
    auto ptr = reinterpret_cast<void*>(
        &hybrid_sparse_grouped_masked_output128x64_nm12_stage4_full_tile_epilogue<
            {}, {}, {}, {}, {}, {}, {}>);
    (void)ptr;
}}
)",
...
static void sm90_hybrid_block_sparse_bf16_grouped_masked_output128x64_nm12_stage4_full_tile_epilogue(
    ...
    const auto args =
        SM90HybridSparseGroupedMaskedOutput128x64NM12Stage4FullTileEpilogueRuntime::Args {
    ...
    const auto runtime = compiler->build(
        "sm90_hybrid_sparse_grouped_masked_output128x64_nm12_stage4_full_tile_epilogue",
        SM90HybridSparseGroupedMaskedOutput128x64NM12Stage4FullTileEpilogueRuntime::generate(args));
    SM90HybridSparseGroupedMaskedOutput128x64NM12Stage4FullTileEpilogueRuntime::launch(runtime, args);
}
