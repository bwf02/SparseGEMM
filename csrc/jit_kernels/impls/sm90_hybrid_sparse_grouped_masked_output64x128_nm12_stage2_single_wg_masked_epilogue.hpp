...
class SM90HybridSparseGroupedMaskedOutput64x128NM12Stage2SingleWGMaskedEpilogueRuntime final:
        public LaunchRuntime<SM90HybridSparseGroupedMaskedOutput64x128NM12Stage2SingleWGMaskedEpilogueRuntime> {
public:
    struct Args {
        void* block_selector;
    ...
    static std::string generate_impl(const Args& args) {
        return fmt::format(R"(
#include <deep_gemm/impls/sm90_hybrid_sparse_grouped_masked_output64x128_nm12_stage2_single_wg_masked_epilogue.cuh>

static void __instantiate_kernel() {{
    auto ptr = reinterpret_cast<void*>(
        &hybrid_sparse_grouped_masked_output64x128_nm12_stage2_single_wg_masked_epilogue<
            {}, {}, {}, {}, {}, {}, {}>);
    (void)ptr;
}}
...
static void sm90_hybrid_block_sparse_bf16_grouped_masked_output64x128_nm12_stage2_single_wg_masked_epilogue(
    ...
    const auto tensor_map_output = make_tma_cd_desc(
        d, num_experts * max_m, n, 64, 128, n, 1, 128);
    const int total_tiles = num_experts * (n / 128);
    const auto args = SM90HybridSparseGroupedMaskedOutput64x128NM12Stage2SingleWGMaskedEpilogueRuntime::Args {
    ...
    const auto runtime = compiler->build(
        "sm90_hybrid_sparse_grouped_masked_output64x128_nm12_stage2_single_wg_masked_epilogue",
        SM90HybridSparseGroupedMaskedOutput64x128NM12Stage2SingleWGMaskedEpilogueRuntime::generate(args));
    SM90HybridSparseGroupedMaskedOutput64x128NM12Stage2SingleWGMaskedEpilogueRuntime::launch(runtime, args);
}
