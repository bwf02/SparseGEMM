...
class SM90HybridSparseGroupedMaskedOutput64x64NM12Stage2ThreeCTARuntimeKRuntime final:
        public LaunchRuntime<SM90HybridSparseGroupedMaskedOutput64x64NM12Stage2ThreeCTARuntimeKRuntime> {
public:
    struct Args {
        void* block_selector;
    ...
    static std::string generate_impl(const Args& args) {
        return fmt::format(R"(
#include <deep_gemm/impls/sm90_hybrid_sparse_grouped_masked_output64x64_nm12_stage2_three_cta_runtime_k.cuh>

static void __instantiate_kernel() {{
    auto ptr = reinterpret_cast<void*>(
        &hybrid_sparse_grouped_masked_output64x64_nm12_stage2_three_cta_runtime_k<
            {}, {}, {}, {}, {}, {}, {}>);
    (void)ptr;
}}
)",
...
static void sm90_hybrid_block_sparse_bf16_grouped_masked_output64x64_nm12_stage2_three_cta_runtime_k(
    ...
    const auto args = SM90HybridSparseGroupedMaskedOutput64x64NM12Stage2ThreeCTARuntimeKRuntime::Args {
        ...
        .launch_args = LaunchArgs(
            std::min(total_tiles, 3 * device_runtime->get_num_sms()),
            256, smem_bytes),
    };
    const auto runtime = compiler->build(
        "sm90_hybrid_sparse_grouped_masked_output64x64_nm12_stage2_three_cta_runtime_k",
        SM90HybridSparseGroupedMaskedOutput64x64NM12Stage2ThreeCTARuntimeKRuntime::generate(args));
    SM90HybridSparseGroupedMaskedOutput64x64NM12Stage2ThreeCTARuntimeKRuntime::launch(runtime, args);
}
