...
class SM90HybridSparseGroupedMaskedOutput128x128NM12Stage3PersistentRuntime final:
        public LaunchRuntime<SM90HybridSparseGroupedMaskedOutput128x128NM12Stage3PersistentRuntime> {
public:
    struct Args {
        void* block_selector;
    ...
    static std::string generate_impl(const Args& args) {
        return fmt::format(R"(
#include <deep_gemm/impls/sm90_hybrid_sparse_grouped_masked_output128x128_nm12_stage3_persistent.cuh>
...
static void sm90_hybrid_block_sparse_bf16_grouped_masked_output128x128_nm12_stage3_persistent(
    ...
    const auto args =
        SM90HybridSparseGroupedMaskedOutput128x128NM12Stage3PersistentRuntime::Args {
    ...
    const auto runtime = compiler->build(
        "sm90_hybrid_sparse_grouped_masked_output128x128_nm12_stage3_persistent",
        SM90HybridSparseGroupedMaskedOutput128x128NM12Stage3PersistentRuntime::generate(args));
    SM90HybridSparseGroupedMaskedOutput128x128NM12Stage3PersistentRuntime::launch(runtime, args);
}
