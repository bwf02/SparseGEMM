...
class SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage2NoTailSyncRuntime final:
        public LaunchRuntime<SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage2NoTailSyncRuntime> {
public:
    struct Args {
        void* block_selector;
    ...
    static std::string generate_impl(const Args& args) {
        return fmt::format(R"(
#include <deep_gemm/impls/sm90_hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage2_no_tail_sync.cuh>

static void __instantiate_kernel() {{
    auto ptr = reinterpret_cast<void*>(
        &hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage2_no_tail_sync<
            {}, {}, {}, {}, {}, {}, {}>);
    (void)ptr;
}}
)",
...
static void sm90_hybrid_block_sparse_bf16_grouped_masked_output64x64_nm12_fixed_stage2_no_tail_sync(
    ...
    const auto args = SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage2NoTailSyncRuntime::Args {
    ...
    const auto runtime = compiler->build(
        "sm90_hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage2_no_tail_sync",
        SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage2NoTailSyncRuntime::generate(args));
    SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage2NoTailSyncRuntime::launch(runtime, args);
}
