...
class SM90HybridSparseGroupedMaskedOutput64x128NM12Stage2SingleWGRuntime final:
        public LaunchRuntime<SM90HybridSparseGroupedMaskedOutput64x128NM12Stage2SingleWGRuntime> {
public:
    struct Args {
        void* block_selector;
    ...
    static std::string generate_impl(const Args& args) {
        return fmt::format(R"(
#include <deep_gemm/impls/sm90_hybrid_sparse_grouped_masked_output64x128_nm12_stage2_single_wg.cuh>

static void __instantiate_kernel() {{
    auto ptr = reinterpret_cast<void*>(
        &hybrid_sparse_grouped_masked_output64x128_nm12_stage2_single_wg<
            {}, {}, {}, {}, {}, {}, {}>);
    (void)ptr;
}}
...
static void sm90_hybrid_block_sparse_bf16_grouped_masked_output64x128_nm12_stage2_single_wg(
    ...
    const auto args = SM90HybridSparseGroupedMaskedOutput64x128NM12Stage2SingleWGRuntime::Args {
    ...
    const auto runtime = compiler->build(
        "sm90_hybrid_sparse_grouped_masked_output64x128_nm12_stage2_single_wg",
        SM90HybridSparseGroupedMaskedOutput64x128NM12Stage2SingleWGRuntime::generate(args));
    SM90HybridSparseGroupedMaskedOutput64x128NM12Stage2SingleWGRuntime::launch(runtime, args);
}
