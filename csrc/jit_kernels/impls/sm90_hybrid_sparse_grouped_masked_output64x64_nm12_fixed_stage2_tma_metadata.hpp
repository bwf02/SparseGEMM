...
class SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage2TmaMetadataRuntime final:
        public LaunchRuntime<SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage2TmaMetadataRuntime> {
public:
    struct Args {
        void* block_selector;
    ...
    static std::string generate_impl(const Args& args) {
        return fmt::format(R"(
#include <deep_gemm/impls/sm90_hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage2_tma_metadata.cuh>

static void __instantiate_kernel() {{
    auto ptr = reinterpret_cast<void*>(
        &hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage2_tma_metadata<
            {}, {}, {}, {}, {}, {}, {}>);
    (void)ptr;
}}
)",
...
static void sm90_hybrid_block_sparse_bf16_grouped_masked_output64x64_nm12_fixed_stage2_tma_metadata(
    ...
    const auto tensor_map_metadata = make_tma_2d_desc(
        ...
        num_experts * block_rows * block_groups * block_n * 4,
        32, 4, 32, 0);
    ...
    const auto args = SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage2TmaMetadataRuntime::Args {
    ...
    const auto runtime = compiler->build(
        "sm90_hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage2_tma_metadata",
        SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage2TmaMetadataRuntime::generate(args));
    SM90HybridSparseGroupedMaskedOutput64x64NM12FixedStage2TmaMetadataRuntime::launch(runtime, args);
}
