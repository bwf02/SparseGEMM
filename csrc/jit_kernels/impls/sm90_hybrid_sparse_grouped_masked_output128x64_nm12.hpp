...
class SM90HybridSparseGroupedMaskedOutput128x64NM12Runtime final:
        public LaunchRuntime<SM90HybridSparseGroupedMaskedOutput128x64NM12Runtime> {
public:
    struct Args {
        void* block_selector;
    ...
    static std::string generate_impl(const Args& args) {
        return fmt::format(R"(
#include <deep_gemm/impls/sm90_hybrid_sparse_grouped_masked_output128x64_nm12.cuh>

static void __instantiate_kernel() {{
    auto ptr = reinterpret_cast<void*>(
        &hybrid_sparse_grouped_masked_output128x64_nm12<
            {}, {}, {}, {}, {}, {}, {}>);
    (void)ptr;
}}
)",
...
static void sm90_hybrid_block_sparse_bf16_grouped_masked_output128x64_nm12(
    ...
    const auto args =
        SM90HybridSparseGroupedMaskedOutput128x64NM12Runtime::Args {
    ...
    const auto runtime = compiler->build(
        "sm90_hybrid_sparse_grouped_masked_output128x64_nm12",
        SM90HybridSparseGroupedMaskedOutput128x64NM12Runtime::generate(args));
    SM90HybridSparseGroupedMaskedOutput128x64NM12Runtime::launch(runtime, args);
}
