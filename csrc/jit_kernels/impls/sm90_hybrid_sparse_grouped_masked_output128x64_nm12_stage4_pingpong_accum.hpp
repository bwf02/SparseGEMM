...
class SM90HybridSparseGroupedMaskedOutput128x64NM12Stage4PingpongAccumRuntime final:
        public LaunchRuntime<SM90HybridSparseGroupedMaskedOutput128x64NM12Stage4PingpongAccumRuntime> {
public:
    struct Args {
        void* block_selector;
    ...
    static std::string generate_impl(const Args& args) {
        return fmt::format(R"(
#include <deep_gemm/impls/sm90_hybrid_sparse_grouped_masked_output128x64_nm12_stage4_pingpong_accum.cuh>

static void __instantiate_kernel() {{
    auto ptr = reinterpret_cast<void*>(
        &hybrid_sparse_grouped_masked_output128x64_nm12_stage4_pingpong_accum<
            {}, {}, {}, {}, {}, {}, {}>);
    (void)ptr;
}}
)",
...
static void sm90_hybrid_block_sparse_bf16_grouped_masked_output128x64_nm12_stage4_pingpong_accum(
    ...
    const auto args =
        SM90HybridSparseGroupedMaskedOutput128x64NM12Stage4PingpongAccumRuntime::Args {
    ...
    const auto runtime = compiler->build(
        "sm90_hybrid_sparse_grouped_masked_output128x64_nm12_stage4_pingpong_accum",
        SM90HybridSparseGroupedMaskedOutput128x64NM12Stage4PingpongAccumRuntime::generate(args));
    SM90HybridSparseGroupedMaskedOutput128x64NM12Stage4PingpongAccumRuntime::launch(runtime, args);
}
