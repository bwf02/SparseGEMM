...
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_contiguous_output128x128_nm12_stage2_dual_wg.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_contiguous_output64x128_nm12_stage2_single_wg.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_contiguous_output64x128_nm12_stage2_single_wg_async_k2.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_contiguous_output64x128_nm12_stage2_single_wg_merge_rows.hpp"
...
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output128x64_nm12_stage4_full_tile_epilogue.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output128x64_nm12_stage4_pingpong_accum.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output128x128_nm12_stage3_persistent.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output128x128_nm12_stage4_output_reuse_direct_metadata.hpp"
...
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output128x64_nm12_stage2_sync.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output64x64_nm12_fixed_full_grid.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output64x128_nm12_stage2.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output64x128_nm12_stage2_single_wg.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output64x128_nm12_stage2_single_wg_masked_epilogue.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output64x128_nm12_stage2_single_wg_multi_m.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output64x128_nm12_stage2_cluster2.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output64x256_nm12_stage2_single_wg.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output64x64_nm12_fixed_persistent.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output64x64_nm12_stage2_three_cta_runtime_k.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output64x64_nm12_stage3_two_cta_runtime_k.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage2.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage2_no_tail_sync.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage2_masked_epilogue.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage2_tma_metadata.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage3_masked_epilogue.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output32x64_nm12_stage4_adaptive.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage2_merge_k2.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage2_output_reuse_partial_metadata.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_grouped_masked_output64x64_nm12_fixed_stage2_pingpong_accum.hpp"
...
#include "../jit_kernels/impls/sm90_hybrid_sparse_wgmma_tma_fused_stsm_persistent_lane_ready_group_stage_output128x64_nm12_fastpath_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage5_output_reuse.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_wgmma_tma_fused_stsm_persistent_lane_ready_group_stage_output128x64_nm12_fastpath_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage5_async_group2.hpp"
#include "../jit_kernels/impls/sm90_hybrid_sparse_wgmma_tma_fused_stsm_persistent_lane_ready_group_stage_output128x64_nm12_fastpath_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage4_async_group2.hpp"
...
static void hybrid_block_sparse_bf16_gemm_wgmma_tma_fused_stsm_persistent_lane_ready_group_stage_output128x64_nm12_fastpath_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage5_output_reuse(
        const torch::Tensor& a,
        const torch::Tensor& block_selector,
        const torch::Tensor& dense_values,
        const torch::Tensor& sparse_values,
    ...
    sm90_hybrid_block_sparse_bf16_gemm_group_stage_output128x64_nm12_fastpath_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage5_output_reuse(
        a, block_selector, dense_values, sparse_values, hardware_metadata,
        d, m, n, k, block_n, block_m);
}

static void hybrid_block_sparse_bf16_gemm_wgmma_tma_fused_stsm_persistent_lane_ready_group_stage_output128x64_nm12_fastpath_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage5_async_group2(
        const torch::Tensor& a,
        const torch::Tensor& block_selector,
        const torch::Tensor& dense_values,
        const torch::Tensor& sparse_values,
    ...
    sm90_hybrid_block_sparse_bf16_gemm_group_stage_output128x64_nm12_fastpath_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage5_async_group2(
        a, block_selector, dense_values, sparse_values, hardware_metadata,
        d, m, n, k, block_n, block_m);
}

static void hybrid_block_sparse_bf16_gemm_wgmma_tma_fused_stsm_persistent_lane_ready_group_stage_output128x64_nm12_fastpath_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage4_async_group2(
        const torch::Tensor& a,
        const torch::Tensor& block_selector,
        const torch::Tensor& dense_values,
        const torch::Tensor& sparse_values,
    ...
    sm90_hybrid_block_sparse_bf16_gemm_group_stage_output128x64_nm12_fastpath_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage4_async_group2(
        a, block_selector, dense_values, sparse_values, hardware_metadata,
        d, m, n, k, block_n, block_m);
}
...
static void hybrid_block_sparse_bf16_grouped_masked_wgmma_tma(
    ...
    if (block_n == 1 and block_m == 2 and max_m == 64) {
        if (n == 1408 and k == 2048) {
            if (expected_m <= 32) {
                ...
                sm90_hybrid_block_sparse_bf16_grouped_masked_output64x64_nm12_fixed_stage2_tma_metadata(
                    a, block_selector, dense_values, sparse_values,
                    hardware_metadata, masked_m, d, num_experts, max_m,
                    n, k, block_n, block_m);
            }
            ...
            sm90_hybrid_block_sparse_bf16_grouped_masked_output64x128_nm12_stage2(
                a, block_selector, dense_values, sparse_values,
                hardware_metadata, masked_m, d, num_experts, max_m,
                n, k, block_n, block_m);
        }
    ...
    if (block_n == 1 and block_m == 2 and max_m % 128 == 0) {
        if (max_m == 128 && n == 1408 && k == 2048) {
            sm90_hybrid_block_sparse_bf16_grouped_masked_output64x64_nm12_stage2_three_cta_runtime_k(
                a, block_selector, dense_values, sparse_values,
                hardware_metadata, masked_m, d, num_experts, max_m,
                n, k, block_n, block_m);
...
static void register_apis(pybind11::module_& m) {
    ...
    m.def(
        ...
        pybind11::arg("block_m"));
    m.def(
        "hybrid_block_sparse_bf16_gemm_wgmma_tma_fused_stsm_persistent_lane_ready_group_stage_output128x64_nm12_fastpath_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage5_output_reuse",
        &hybrid_block_sparse_bf16_gemm_wgmma_tma_fused_stsm_persistent_lane_ready_group_stage_output128x64_nm12_fastpath_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage5_output_reuse,
        pybind11::arg("a"),
        pybind11::arg("block_selector"),
        pybind11::arg("dense_values"),
        ...
        pybind11::arg("block_m"));
    m.def(
        "hybrid_block_sparse_bf16_gemm_wgmma_tma_fused_stsm_persistent_lane_ready_group_stage_output128x64_nm12_fastpath_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage5_async_group2",
        &hybrid_block_sparse_bf16_gemm_wgmma_tma_fused_stsm_persistent_lane_ready_group_stage_output128x64_nm12_fastpath_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage5_async_group2,
        pybind11::arg("a"),
        pybind11::arg("block_selector"),
        pybind11::arg("dense_values"),
        ...
        pybind11::arg("block_m"));
    m.def(
        "hybrid_block_sparse_bf16_gemm_wgmma_tma_fused_stsm_persistent_lane_ready_group_stage_output128x64_nm12_fastpath_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage4_async_group2",
        &hybrid_block_sparse_bf16_gemm_wgmma_tma_fused_stsm_persistent_lane_ready_group_stage_output128x64_nm12_fastpath_desc_reuse_fused_mma_group_fixed_shape_unroll_k_stage4_async_group2,
        pybind11::arg("a"),
        pybind11::arg("block_selector"),
        pybind11::arg("dense_values"),
